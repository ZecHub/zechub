...
<div className="overflow-x-auto my-8 rounded-3xl border border-border bg-card p-6">
  <table className="w-full border-collapse rounded-2xl overflow-hidden">
    <thead>
      <tr className="border-b border-border bg-amber-100 dark:bg-amber-900">
        <th className="py-5 px-6 text-left font-bold text-amber-800 dark:text-amber-200">Misconception</th>
        <th className="py-5 px-6 text-left font-bold text-amber-800 dark:text-amber-200">Correct Answer</th>
      </tr>
    </thead>
    <tbody>
      <tr className="border-b border-border hover:bg-amber-50 dark:hover:bg-amber-950">
      ...
      <tr className="hover:bg-amber-50 dark:hover:bg-amber-950">
