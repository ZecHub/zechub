...
Several wallets are available for instant, mobile, secure and private payments: [Mobile Wallets](https://z.cash/ecosystem/?wallets=#tag-wallets)
</div>

## How can I acquire Zcash?

<div className="overflow-x-auto my-8 rounded-3xl border border-border bg-card p-6">
You can buy ZEC on cryptocurrency [exchanges](https://z.cash/ecosystem/?exchanges=#tag-exchanges).  
