  ...
  <table className="w-full border-collapse rounded-2xl overflow-hidden">
    <thead>
      <tr className="border-b border-border bg-amber-100 dark:bg-amber-900">
        <th className="py-5 px-6 text-left font-bold text-amber-800 dark:text-amber-200">Term</th>
        <th className="py-5 px-6 text-left font-bold text-amber-800 dark:text-amber-200">Definition</th>
      </tr>
    </thead>
    <tbody>
