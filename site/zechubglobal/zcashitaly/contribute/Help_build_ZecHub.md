Se sei un membro della comunità Zcash e vuoi contribuire allo sviluppo di ZecHub, ci sono alcune cose che sono estremamente utili.
...
Pubblichiamo problemi per le attività per le quali attualmente abbiamo delle ricompense. Principalmente li trovi in [Github Issues](https://github.com/ZecHub/zechub/issues). Puoi trovarli anche su [Dework](https://app.dework.xyz/zechub-2424). Le missioni di ZecHub sono pubblicate su [Zealy](https://zealy.io/cw/zechub).
