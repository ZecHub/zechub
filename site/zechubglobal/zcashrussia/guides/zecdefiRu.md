...
**Ren 2.0 так и не был запущен, а сервис RenBridge закрыт: соответствующие шаги удалены из этого руководства. См. эту [тему](https://forum.zcashcommunity.com/t/ren-1-0-being-sunset-bridge-renzec-to-native-zec-as-soon-as-possible/43393) для подробнее.**

Пользователи Zcash могут использовать смарт-контракты Ethereum и более широкие приложения DeFi, сохраняя при этом свою конфиденциальность, используя этот 4-этапный процесс:
...
### Шаг 4: Конвертируйте ETH обратно в ZEC

RenBridge закрыт: Ren Protocol прекратил работу, а домен сервиса больше не существует.

Когда вы будете готовы обналичить деньги, конвертируйте свои ETH обратно в ZEC, используя:

- [NEAR Intents](https://app.near-intents.org)

- [Maya Protocol](https://www.mayaprotocol.com/ecosystem#user-interfaces/)

В вашем некастодиальном кошельке автоматически конвертируйте прозрачный ZEC в защищённый ZEC.


### Поздравляем!! вы успешно использовали свой Zcash для подключения и использования приложений DeFi с сохранением конфиденциальности.
