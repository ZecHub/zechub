...
Мы публикуем проблемы для задач, которые у нас в настоящее время открыты. В первую очередь их можно найти как [Проблемы Github](https://github.com/ZecHub/zechub/issues). Вы также можете найти их на [Dework](https://app.dework.xyz/zechub-2424). Квесты ZecHub размещены на [Zealy](https://zealy.io/cw/zechub)
