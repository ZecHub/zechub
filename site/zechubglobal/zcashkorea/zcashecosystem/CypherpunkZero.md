...
사이퍼펑크 제로는 젊은 사이퍼펑크 해커이자 자유 투사인 제로를 중심으로 한 스토리텔링 시리즈입니다. Zero는 현재 디스토피아적 악몽 속에서 살고 있으며 코드를 사용하여 사회를 속박하려는 중앙 집권화된 자들과 맞서 싸웁니다.
...
우리는 대부분의 NFT 프로젝트들이 로드맵을 지키지 못하는 것을 보았기 때문에 공식적인 로드맵을 만들지 않았습니다.

NFT 보유자를 위한 독점적인 혜택이 있다는 것을 믿으시고 NFT를 홀딩하세요.
...
- Zcash X Mighty Jaxx: Cypherpunk Zero Genesis Edition Toy 59를 구매한 프로젝트 초기 지지자에게 공급량의 4%(최초 400 NFT)를 에어드롭했습니다.
- 공급량의 72%(7,200 NFT)는 암호화된 메모를 지원하는 Zcash 지갑을 사용해야 하는 새로운 화이트리스트 메커니즘을 사용하여 대중에게 에어드롭했습니다.(자세한 내용은 아래 참조)
