...
We posten problemen voor taken waarvoor we momenteel premies open hebben staan. Deze zijn voornamelijk te vinden als [Github Issues](https://github.com/ZecHub/zechub/issues). Je vindt ze ook op [Dework](https://app.dework.xyz/zechub-2424). ZecHub-missies worden gepost op [Crew3](https://zealy.io/c/zechub)
