...
**Status:** Origin unreachable as of 18 Sep 2026. `zcash.flypool.org` times out (`TimeoutError`). Do not treat this as a live mining pool.

- Last listed website: `https://zcash.flypool.org/`
- Private Payouts: YES (historical listing)
...
- Private Payouts: get paid in Bitcoin (BTC)
- Pool Type: Hashrate Marketplace / Proxy Pool
- Pool fee: 0,5% - 1%
...
- Website: [Sovright Mining Pool](https://mining.sovright.com/)
- Private Payouts: YES
- Pool Type: Pay Per Last N Shares (PPLNS)
- Pool Fee: 1%
