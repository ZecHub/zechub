...
- **Outline:**
 https://drive.google.com/file/d/1eYWLgvAAHzCpr2b7bZ494FTZAtHqmtRk/view
...
## 2. Who Built Zcash and Why Does it Exist?
...
This portion breaks down the technical foundations of the Zcash protocol in approachable language. Key concepts include:

- Transparent vs. shielded addresses  
- Viewing keys and controlled disclosure  
- The role of miners/validators  
- How zero-knowledge proofs validate transactions  
- How privacy is preserved even while ensuring the network remains decentralized and secure  

Diagrams and visual metaphors in the workbook help simplify these concepts for beginners.


---

## 4. Using Zcash in Everyday Life
...
- The role of contributors in open-source development  
- How Zcash network upgrades improve the protocol  
...
## 6. Security, Safety, and Best Practices

This section teaches foundational digital safety habits:

- Protecting keys and seed phrases  
- Avoiding scams  
- Understanding custodial vs. non-custodial wallets  
- Practicing strong password hygiene  
- Avoiding sharing sensitive wallet information publicly  

These lessons equip new users with key habits that extend beyond Zcash into general digital life.


---

## 7. The Global Zcash Community
...
- **Ice (@frostbyte11211)** – A high schooler interested in privacy, computers, cryptography, and psychology.  
- **Pacu (@thecodebuffet)** – A longtime Zcash wallet developer, previously at ECC working on SDKs and Light Client technology, now contributing to the ecosystem under a ZCG grant.  
- **Marek** – An engineer at the Zcash Foundation.  
- **Alfredo Garcia** – A Rust systems engineer working on the Zebra team at the Zcash Foundation.  
- **Pili (@mpguerra)** – Engineering Manager at the Zcash Foundation with 20+ years of experience, including work on the Tor Project.  
- **Zksquirrel** – Zcash Arborist, community note taker, and contributor to ZecHub’s education initiatives.  
- **Tripleyouww** – Community Support Coordinator at the Zcash Foundation.  
- **Mass Adoption Alliance** – An initiative empowering youth through education on decentralized cryptocurrencies and financial privacy.
...
The final section invites readers to become part of the Zcash ecosystem. Opportunities include:

- Joining the Zcash Global Discord  
- Participating in community calls and working groups  
...
*My First Zcash* is licensed under the **Creative Commons Attribution-ShareAlike 4.0 International License (CC BY-SA 4.0).**
