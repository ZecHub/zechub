...
In August 2026, Zcash got its first US exchange-traded product. The Zcash ETF, trading under the ticker ZCSH on NYSE Arca, is sponsored by Grayscale and holds actual ZEC. Within two weeks of its exchange debut it reported more than $500 million in assets, a September 8 disclosure described a related-party in-kind creation of roughly $100 million of new shares for ZEC, and options on the shares began trading the same day.
...
The key implication: **headline "inflows" into ZCSH do not mean the trust bought ZEC on an exchange.** An inflow means an AP delivered ZEC (or cash that became ZEC through a liquidity provider) to the trust through the primary creation mechanism. The ZEC ends up in the trust's custody either way, but the market mechanics — and what the flow says about demand — are different from open-market buying by the trust itself. (Cash creations do involve market buying, through the liquidity providers; see below.)
...
The transaction had been pre-disclosed in the prospectus as a non-binding "Potential Contribution Arrangement" contemplating roughly 200,000 ZEC. Only about 85,705 ZEC actually changed hands — because ZEC's price more than doubled between the disclosure and the closing, the token count fell while the dollar figure stayed near $100 million (implying roughly $1,166 per ZEC at closing versus roughly $500 at disclosure).

What this proves: a sponsor affiliate contributed ZEC it already held into the trust through an **in-kind creation via an Authorized Participant**, receiving newly created ordinary shares. It added roughly 85,700 ZEC to the trust's holdings in one stroke. The same day's press release reported cumulative net inflows of more than $70 million in the product's first two weeks and assets above $500 million. Those figures sit uneasily together: an in-kind creation is an inflow, so $100M of new-share creations cannot sit inside $70M of net inflows without some difference in definition (cash-only, unaffiliated, or a different cutoff) that the press release does not spell out. Treat the $70M and the $100M as separately reported figures, not as parts of one total.
...
**ETF-held ZEC and circulating supply.** ZEC delivered into the trust — whether via in-kind creations like the DCG transaction or cash creations converted through liquidity providers — leaves the liquid, transactable supply and sits in custody. It returns only through cash redemptions, which sell ZEC for dollars. In that sense the trust acts as a sink while inflows persist: ZEC goes in, shares come out, and the ZEC does not come back except through the redemption channel.
...
- NYSE Arca certification to the SEC Division of Corporation Finance, dated August 24, 2026 — listing and registration approval. https://www.sec.gov/Archives/edgar/data/0001720265/000114336226000322/ZCSH082426.pdf
...
- Form 10-Q filings of the predecessor Zcash Trust (pre-conversion), SEC EDGAR under CIK 1720265 — earlier fee-payment description (monthly vs daily).
- Coinbase Global, Inc. securities filings, SEC EDGAR — custodian crime-insurance coverage disclosure (coverage shared across custody clients; total crypto held exceeds total coverage).
