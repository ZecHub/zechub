...
<table className="w-full max-w-[950px] mx-auto my-8 border-collapse shadow-xl rounded-2xl overflow-hidden">
  <thead>
    <tr>
      <th className="bg-[#15803d] text-white px-6 py-5 text-left font-bold text-[1.05rem]">Feature</th>
      <th className="bg-[#15803d] text-white px-6 py-5 text-left font-bold text-[1.05rem]">Previous Zingo Versions</th>
      <th className="bg-[#15803d] text-white px-6 py-5 text-left font-bold text-[1.05rem]">Zingo 2.0 with Pepper Sync</th>
    </tr>
  </thead>
  <tbody>
