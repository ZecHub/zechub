...
abstract class S {
  ...
  ///
  /// In en, this message translates to:
  /// **'Do you want to DELETE the secret key and convert this account to a watch-only account? You will not be able to spend from this account on this device anymore. This operation is NOT reversible.'**
