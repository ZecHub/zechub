        ...
        {!seed || rows.length === 0 ? (
          ...
          <>
            ...
            <div className="panel guardians-note">
              ...
              <p className="fine">
                The link opens the <span className="data">Vaults I guard</span> section at{' '}
                <span className="data">{GUARDIAN_BASE_URL}</span>, prefilled with their share — each
                guardian opens it in their own browser (a separate window / Incognito from yours).
                They set a passphrase, which seals the share on their device with argon2id — you
                never hold it. If a link is awkward to send, use the raw share instead: reveal it,
                and they paste it into the Enrol screen.
              </p>
            </div>
