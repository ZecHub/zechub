...
/**
 * Get generic vite plugins according to conditions
 */
...
/**
 * Get application type vite plugins according to conditions
 */
async function loadApplicationPlugins(
  options: ApplicationPluginOptions,
): Promise<PluginOption[]> {
  // Take it alone, otherwise they won't get it.
...
/**
 * Get library-type vite plugins according to conditions
 */
