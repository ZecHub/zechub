...
async function handleExport() {
  ...
  downloadFileFromBlobPart({ fileName: 'Dictionary Type.xls', source: data });
}
...
<template>
  <div class="h-full">
    ...
    <Grid table-title="List of Dictionary Types">
      <template #toolbar-tools>
        <TableAction
          :actions="[
            {
              label: $t('ui.actionTitle.create', ['Dictionary Type']),
              type: 'primary',
