  ...
  configVxeTable: (vxeUI) => {
    vxeUI.setConfig({
      grid: {
        ...
        minHeight: 180,
        formConfig: {
          // Disable vxe-table form configuration globally, usingformOptions
          enabled: false,
        },
        toolbarConfig: {
          import: false, // Import
          export: false, // Whether or not to export
          refresh: true, // Whether or not to refresh
          print: false, //
          zoom: true, // Whether or not to scale
          custom: true, // Custom Configuration
        },
        customConfig: {
          mode: 'modal',
        },
    ...
    // Table configs can be used for cellRender: {name: 'CellImage'},
    ...
    // Table configs can be used for cellRender: {name: 'CellLink'},
    ...
    // Table configs can be used for cellRender: {name: 'CellTag'},
    ...
    // Table configurations can be used for cellRender: {name: 'CellDict', props: {dictType: '},
    vxeUI.renderer.add('CellDict', {
      renderTableDefault(renderOpts, params) {
        ...
        // Replace the original implementation with a DictTag component
        return h(DictTag, {
          type: props.type,
    ...
    //  cellRender: { name: 'CellSwitch', props: { beforeChange: () => {} } },
    ...
    // Operation button renderer for registered forms: {name: 'CellOperation', options: [`edit', 'delete']}
    ...
    // This can expand the global configuration of vxe-table on its own, such as custom formatting
    // vxeUI.formats.add
    ...
    // Add by asterisk: Quantified, 3 bit reserved
    vxeUI.formats.add('formatAmount3', {
      tableCellFormatMethod({ cellValue }) {
        return erpCountInputFormatter(cellValue);
      },
    });
    // Add by asterisk: Quantified, 2 bits reserved
    ...
    // Add by Astronomy: Format file size
