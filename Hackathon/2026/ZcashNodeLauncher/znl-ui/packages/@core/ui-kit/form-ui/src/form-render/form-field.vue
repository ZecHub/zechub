...
const shouldRequired = computed(() => {
  ...
  // If default values are set, they are not mandatory and require special processing
...
function fieldBindEvent(slotProps: Record<string, any>) {
  ...
  // Some components of the antd design will pass on an event object
...
function autofocus() {
  if (
    ...
    // Check if current elements are focused
