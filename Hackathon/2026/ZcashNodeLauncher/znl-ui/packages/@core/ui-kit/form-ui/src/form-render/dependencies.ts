...
export default function useDependencies(
  ...
  watch(
    ...
    async ([_values, dependencies]) => {
      ...
      // 1. Prioritize judgement if if if if if false, do not rewrite dom and follow-up judgement is no longer enforced
      ...
      // 2. Adjudication of how, if show is false, hide
      if (isFunction(show)) {
