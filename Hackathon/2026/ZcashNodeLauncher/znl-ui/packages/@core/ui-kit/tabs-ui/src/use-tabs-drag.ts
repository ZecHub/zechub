...
// Maybe we'll find the dragged sub-elements, and here we need to make sure the dragged domtab elements.
    ...
    const { initializeSortable } = useSortable(el, {
      ...
      onMove(evt) {
        ...
        if (parent?.classList.contains('draggable') && props.draggable) {
          ...
          // It's not allowed to drag one another between fixed tabs and non-fixed tabs.
