...
/* 1. Declaration of transitional effects */
.fade-move,
.fade-enter-active,
.fade-leave-active {
...
/* 3. Ensures that the departure items are removed from the layout stream in order to calculate the animation effect of the movement correctly. */
.fade-leave-active {
  position: absolute;
}
</style>