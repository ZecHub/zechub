...
/**
 * If you turn on the key Alive, you go back directly through the browser buttons/hand gestures, etc., and you don't close the window.
 */
onDeactivated(() => {
  // Close the window if it is not mounted into the content area
...
/**
 * destroyOnClose fully functional
 */
// Did you open it?
