...
/**
 * Design systems for adapting frameworks
 */
...
export function useAntdDesignTokens() {
  ...
  const tokens = reactive({
    ...
    colorTextBase: '',
    colorWarning: '',
    zIndexPopupBase: 2000, // Adjust the base layer level to avoid drop-down components being blocked by windows or tables in maximum condition
  });
  ...
  watch(
    ...
    () => {
      ...
      const variables: Record<string, string> = {
        ...
        // Solve ElLoading Background Colours
