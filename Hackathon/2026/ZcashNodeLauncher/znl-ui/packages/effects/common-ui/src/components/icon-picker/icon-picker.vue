...
interface Props {
  ...
  prefix?: string;
  /** Whether to request API automatically to get data from the icon set. Effective when providing prefix */
  ...
  /** icon insert slot name, the preview icon will be rendered to this slot */
  iconSlot?: string;
  /** Value property name for input component */
...
/* Reset sub-pages when searching for changes in keywords */
