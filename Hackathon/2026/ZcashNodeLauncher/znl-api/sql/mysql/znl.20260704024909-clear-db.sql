...
CREATE TABLE `infra_api_error_log` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT 'Tenant Number',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=22681 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='System Anomalous Log';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_login_log` (
  ...
  `user_id` bigint NOT NULL DEFAULT '0' COMMENT 'User ID',
  `user_type` tinyint NOT NULL DEFAULT '0' COMMENT 'User Type',
  `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '_Other Organiser',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT 'Tenant Number',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4044 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='System access logs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `system_login_log` (`id`, `log_type`, `trace_id`, `user_id`, `user_type`, `username`, `result`, `user_ip`, `user_agent`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (4041,100,'',1,2,'zcashjava',0,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36',NULL,'2026-07-04 00:17:45',NULL,'2026-07-04 00:17:45',0x00,1);
INSERT INTO `system_login_log` (`id`, `log_type`, `trace_id`, `user_id`, `user_type`, `username`, `result`, `user_ip`, `user_agent`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (4042,100,'',1,2,'zcashjava',0,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36',NULL,'2026-07-04 00:18:38',NULL,'2026-07-04 00:18:38',0x00,1);
INSERT INTO `system_login_log` (`id`, `log_type`, `trace_id`, `user_id`, `user_type`, `username`, `result`, `user_ip`, `user_agent`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (4043,100,'',1,2,'zcashjava',0,'0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36',NULL,'2026-07-04 00:27:34',NULL,'2026-07-04 00:27:34',0x00,1);
...
CREATE TABLE `system_menu` (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT 'Delete',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5065 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Menu Permission Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5042,'Zcash','',1,8,0,'/zcash','carbon:currency-dollar',NULL,NULL,0,0x01,0x01,0x01,'1','2026-06-26 16:43:32','1','2026-06-26 16:43:32',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5043,'Installation Script','zcash:installation-script:list',2,2000,5042,'installationScript','carbon:ibm-watsonx-code-assistant-for-z-refactor','zcash/installationScript/index','ZcashInstallationScript',0,0x01,0x01,0x01,'1','2026-06-26 16:47:39','1','2026-06-26 17:21:16',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5044,'Query Installation Script','zcash:installation-script:query',3,1000,5043,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 16:48:45','1','2026-06-26 16:48:55',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5045,'Create Installation Script','zcash:installation-script:create',3,2000,5043,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 16:49:24','1','2026-06-26 16:49:24',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5046,'Edit Installation Script','zcash:installation-script:update',3,3000,5043,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 16:49:55','1','2026-06-26 16:49:55',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5047,'Delete Installation Script','zcash:installation-script:delete',3,4000,5043,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 16:50:15','1','2026-06-26 16:50:15',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5048,'Export Installation Script','zcash:installation-script:export',3,5000,5043,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 16:50:36','1','2026-06-26 16:50:36',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5049,'Import Installation Script','zcash:installation-script:import',3,6000,5043,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 16:50:58','1','2026-06-26 16:50:58',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5050,'Node Server','zcash:node-server:list',2,1000,5042,'nodeServer','carbon:edge-node-alt','zcash/nodeServer/index','NodeServer',0,0x01,0x01,0x01,'1','2026-06-26 19:10:47','1','2026-06-26 19:11:42',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5051,'Query Node Server','zcash:node-server:query',3,1000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 19:12:12','1','2026-06-26 19:12:12',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5052,'Create Node Server','zcash:node-server:create',3,2000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 19:12:31','1','2026-06-26 19:12:31',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5053,'Edit Node Server','zcash:node-server:update',3,3000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 19:12:51','1','2026-06-26 19:12:51',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5054,'Delete Node Server','zcash:node-server:delete',3,4000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 19:13:32','1','2026-06-26 19:13:32',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5055,'Export Node Server','zcash:node-server:export',3,5000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 19:13:51','1','2026-06-26 19:13:51',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5056,'Import Node Server','zcash:node-server:import',3,6000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-26 19:14:31','1','2026-06-26 19:14:31',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5057,'Refresh Status','zcash:node-server:refresh-status',3,53000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-27 02:24:12','1','2026-06-27 21:11:28',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5058,'Start','zcash:node-server:start',3,51000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-27 02:24:29','1','2026-06-27 03:03:37',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5059,'Stop','zcash:node-server:stop',3,52000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-27 02:24:46','1','2026-06-27 03:03:43',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5060,'Install','zcash:node-server:install',3,58000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-27 02:25:08','1','2026-06-27 03:04:23',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5061,'Uninstall','zcash:node-server:uninstall',3,59000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-27 02:25:32','1','2026-06-27 03:04:29',0x00);
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5062,'Show Status','zcash:node-server:show-status',3,54000,5050,'','','','',0,0x01,0x01,0x01,'1','2026-06-27 03:04:12','1','2026-07-01 04:38:07',0x00);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='OAuth2 access token';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_oauth2_client` (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT 'Delete',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='OAuth2 Client Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_oauth2_refresh_token` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT 'Tenant Number',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='OAuth2 Refresh Decoration';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_tenant` (
  ...
  `contact_user_id` bigint DEFAULT NULL COMMENT '_Other Organiser',
  `contact_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '_Other Organiser',
...
CREATE TABLE `system_tenant_package` (
  ...
  `menu_ids` varchar(4096) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Could not close temporary folder: %s',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'Creater',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Updater',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update Time',
...
CREATE TABLE `system_users` (
  ...
  `username` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '_Other Organiser',
...
INSERT INTO `system_users` (`id`, `username`, `password`, `nickname`, `remark`, `dept_id`, `post_ids`, `email`, `mobile`, `sex`, `avatar`, `status`, `login_ip`, `login_date`, `creator`, `create_time`, `updater`, `update_time`, `deleted`, `tenant_id`) VALUES (1,'zcashjava','$2a$04$GV2dH3EobeNQfRBjqYUu/uNBnjGlZ1KTxDoAlVgWi4vdWF1IeBOyG','ZcashJava','ZcashJava',103,'[1,2]','zcashjava@outlook.com','#',2,'/static/imgs/zcash.png',0,'0:0:0:0:0:0:0:1','2026-07-04 00:27:34','zcashjava','2021-01-05 17:03:47',NULL,'2026-07-04 00:27:34',0x00,1);
/*!40000 ALTER TABLE `system_users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `zcash_installation_script`
--

DROP TABLE IF EXISTS `zcash_installation_script`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `zcash_installation_script` (
  ...
  `sort` int DEFAULT NULL COMMENT 'Show Order',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Remarks',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Creater',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Updater',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT 'Tenant Number',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Installation script';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `zcash_installation_script`
--

LOCK TABLES `zcash_installation_script` WRITE;
/*!40000 ALTER TABLE `zcash_installation_script` DISABLE KEYS */;
/*!40000 ALTER TABLE `zcash_installation_script` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `zcash_node_server`
--

DROP TABLE IF EXISTS `zcash_node_server`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `zcash_node_server` (
  ...
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Name',
  `port` int NOT NULL COMMENT 'default: 21',
  ...
  `node_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Pruning Node/ Full Node',
  `proxy_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'proxy type',
  `proxy_host` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'proxy host',
  `proxy_port` int DEFAULT NULL COMMENT 'proxy port',
  `proxy_username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'proxy username',
  `proxy_password` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'proxy password',
  `server_status` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'online / lost',
  ...
  `server_status_check_time` datetime DEFAULT NULL COMMENT 'server status check time',
  `installation_status` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'not installed / installed',
  `installation_log` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'ssh output',
  `installation_status_check_time` datetime DEFAULT NULL COMMENT 'installation status check time',
  `node_status` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'created / running / paused / restarting / dead / removing / exited',
  `node_error` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'node start error',
  `node_status_check_time` datetime DEFAULT NULL COMMENT 'node status check time',
  `node_info_cache_update_time` datetime DEFAULT NULL COMMENT 'node info cache update time',
  `sort` int DEFAULT NULL COMMENT 'Show Order',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Remarks',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Creater',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT 'Tenant Number',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Node server';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `zcash_node_server`
--

LOCK TABLES `zcash_node_server` WRITE;
/*!40000 ALTER TABLE `zcash_node_server` DISABLE KEYS */;
/*!40000 ALTER TABLE `zcash_node_server` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-07-04  2:49:09
