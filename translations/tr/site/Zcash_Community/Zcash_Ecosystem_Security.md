...
- [zcash/zcash'te Bir Güvenlik Açığı Bildirin](https://github.com/zcash/zcash/security/policy)
- [ZF'ye Güvenlik Açığı Bildirin](https://github.com/ZcashFoundation/zebra/security/policy)
