# Zcash Kullanarak Mobil Kontör Yükleme

Bu rehberde, ZEC ile nasıl kontör satın alacağınızı öğreneceksiniz.

## Şu adımları izleyin:

### 1. Bir hesap oluşturun
[Coinsbee.com](https://www.coinsbee.com/en/shop/mobile-top-ups/) adresini ziyaret edin ve bir hesap oluşturun.
...
Son zamanlarda Zcash, birkaç yeni kullanım alanına sahne oldu ve bu da onu günlük kullanım için daha da pratik hale getirdi. Birçok çevrim içi mağaza ve satıcı, özellikle gizlilik dostu işlemlere öncelik verenler, mal ve hizmetler için ödeme yöntemi olarak ZEC kabul ediyor.  

Bir işletmeniz var ve ZEC ödemelerini kabul etmeye başlamak mı istiyorsunuz? [PayWithZash](https://paywithz.cash/) ile işletmeniz, sunduğu hizmetler için ZEC kabul eden işletmeler listesine eklenebilir.
