...
3) **Anonimlik Kümesi**: Sıfır bilgi shielded havuzlarının [anonimlik kümesi](https://docs.wasabiwallet.io/FAQ/FAQ-UseWasabi.html#what-is-the-difference-between-anonymity-set-and-anonymity-score), şimdiye kadar gerçekleşmiş *tüm* işlemlerden oluşur. Bu, işlem bağlantısızlığını sağlamak için kullanılan diğer çoğu zincir üstü tekniğe kıyasla çok daha büyüktür. Not: bu yalnızca aynı shielded havuz içindeki işlemler için geçerlidir.
