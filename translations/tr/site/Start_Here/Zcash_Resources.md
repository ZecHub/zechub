...
Kullanıcıların Zcash'i anlamasına yardımcı olan çeşitli kaynaklar vardır.

**[Zcash Medya](https://www.youtube.com/c/ZcashMedia)**
...
Zcash Foundation projelerini barındıran bir diğer GitHub deposu; buna Rust ile yazılmış bir Zcash düğüm uygulaması olan [zebra](https://github.com/ZcashFoundation/zebra) da dahildir.

**[Halo2](https://zcash.github.io/halo2/index.html)**

Sıfır bilgi ispat sistemlerinin arkasındaki kavramlar.

**[Zcash RPC Dokümanları](https://zcash.github.io/rpc/)**

zcashd için mevcut tüm komutların listesi.
