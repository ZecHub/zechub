...
- Fonctionnalités : Carnet d’adresses | CrossPay | Near Intents | Paiements Flexa | Multisignature | Demande de paiement | Mémo blindé | Dépenser avant la synchronisation | Adresse TEX | Prise en charge de Tor | F-droid
- Ironwood : Prêt
...
- Fonctionnalités : Blindage automatique | Swaps DEX | Multi-monnaie | Mémo blindé | Dépenser avant la synchronisation
...
- Prise en charge du portefeuille : Phrase de récupération | Unified Address
- Pools : Transparent | Sapling | Ironwood
- Fonctionnalités : Swaps DEX | Multi-monnaie | Dépenser avant la synchronisation
- Ironwood : Prêt
...
- Prise en charge du portefeuille : Phrase de récupération | Viewing Key | Unified Address | Matériel
- Pools : Transparent | Sapling | Ironwood
- Fonctionnalités : Rotation d’adresse | Large prise en charge des clés | Exportations chiffrées | Multisig FROST | Synchronisation multi-comptes | Mémo blindé | Prise en charge du testnet
- Ironwood : Prêt
...
- Prise en charge du portefeuille : Phrase de récupération | Viewing Key | Unified Address
- Pools : Transparent | Sapling | Ironwood
- Fonctionnalités : Carnet d’adresses | Rotation d’adresse | Blindage automatique | Swaps DEX | Multi-monnaie | Mémo blindé | Prise en charge de Tor
- Ironwood : Prêt
...
- Système d’exploitation : Android | iOS | Windows | Linux | macOS | Navigateur
- Pools : Transparent
- Fonctionnalités : Multi-monnaie | Application Web
...
- Fonctionnalités : Extension de navigateur | Transactions blindées | Swaps interchaînes | Prêts et emprunts | Connexions DApp | Rhea
- Ironwood : Prêt
...
- Prise en charge du portefeuille : Phrase de récupération | Portefeuille externe | Adresse de réception | Code QR | Matériel
- Pools : Sapling | Transparent
- Fonctionnalités : Multi-monnaie | Near Intents | Maya DEX | Sans KYC | Non dépositaire | Application Web | Application de bureau | ZEC blindé | AnyPay
- Ironwood : Prêt
...
- Prise en charge du portefeuille : Phrase de récupération | Viewing Key | Unified Address | Clé privée | Clé de dépense | Sauvegarde du portefeuille / Exportation de clé | Portefeuille de nœud complet
...
- Prise en charge du portefeuille : Phrase de récupération | Passkey | Unified Address | Clé privée | Portefeuille auto-hébergé
- Pools : Transparent | Sapling | Ironwood
- Fonctionnalités : Auto-conservation | Clé privée stockée localement | Aucun KYC requis | Aucune dépendance au serveur Zend pour l’activité du portefeuille | Transaction blindée chiffrée | Récupération par phrase de récupération | Mémo blindé | Authentification par Passkey

---

## [Nozy Wallet](https://github.com/LEONINE-DAO/Nozy-wallet)
![logo](/content-images/nozy.webp "Nozy Wallet")
- Appareils : Bureau | Navigateur
- Système d’exploitation : Linux | iOS | macOS
- Prise en charge du portefeuille : Phrase de récupération | Viewing Key | Unified Address | Clé de dépense | Portefeuille HD | Gestion des clés privées
- Pools : Transparent | Sapling | Ironwood
- Fonctionnalités : Carnet d’adresses | Prise en charge de Tor | Prise en charge d’I2P | Intégration Zebra/Zebrad | Historique des transactions | Exportation des transactions | Dérivation locale des témoins | Frais dynamiques (ZIP-317) | Compatibilité NU6.2 | Prise en charge de la migration NU6.3 | Mémo blindé
- Ironwood : Prêt
...
- Prise en charge du portefeuille : Phrase de récupération | Viewing Key | Unified Address | Portefeuille multi-comptes | Portefeuille auto-hébergé | Gestion des clés privées | Prise en charge du portefeuille d’agent
- Pools : Transparent | Sapling | Ironwood
- Fonctionnalités : NEAR Intents | Demandes de paiement | Mémo blindé | Transaction blindée par défaut | Testnet | Swap interchaîne | CipherPay | Viewing Key | Agent IA | Serveur MCP | Portefeuille CLI | FROST | Bêta
- Ironwood : En cours
...
- Appareils : Bureau
- Système d’exploitation : Windows | Linux | macOS
- Prise en charge du portefeuille : Phrase de récupération | Clé de dépense | Clé privée | Sauvegarde du portefeuille / Exportation de clé
- Pools : Transparent | Sapling | Ironwood | Sprout
- Fonctionnalités : Récupération du portefeuille | Interface en ligne de commande | Mémo blindé | Prise en charge du testnet
- Ironwood : Prêt
