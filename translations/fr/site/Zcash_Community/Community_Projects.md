...
Découvrez des outils, wallets, applications, bibliothèques et initiatives de l’écosystème créés par la communauté Zcash et l’écosystème plus large de la preuve à divulgation nulle de connaissance.
...
### My First Zcash
Cahier d’exercices éducatif créé par la communauté mondiale Zcash.  
...
### ZShieldHer
Site éducatif Zcash pour les survivantes de violences domestiques.  
[Visiter](https://zshieldher.com/)

### ZecForge
Atelier de création pour l’écosystème Zcash axé sur l’onboarding, le développement des créateurs et la diffusion de contenu.  
...
### Zcast
Podcast Zcash en espagnol avec les dernières mises à jour de l’écosystème.  
[Visiter](https://www.youtube.com/@ZcastEsp)

### Zero-knowledge Audiovisual Club (ZKAV)
Collectif audiovisuel axé sur la confidentialité qui forme, co-crée et fournit un soutien AV bénévole pour les événements communautaires liés aux technologies open source et décentralisées.  
[Visiter](https://zkav.club/)

### Zcash Network School
Contenu éducatif structuré pour les nouveaux utilisateurs et développeurs Zcash.  
...
### ZGo
Caisse enregistreuse Zcash qui permet aux vendeurs et commerçants d’accepter les paiements Zcash.  
...
### ZODL
Wallet Zcash phare de ZODL (anciennement Zashi). Disponible sur iOS et Android. Prend en charge le ZEC protégé et le vote des détenteurs de NU7.  
...
### ZecVault
Wallet d’épargne fondé sur des objectifs, construit sur les transactions protégées de Zcash.  
...
### MonteZecret
Wallet de bureau léger expérimental pour Zcash, écrit en Rust.  
[Forum](https://forum.zcashcommunity.com/t/montezecret-a-desktop-wallet-for-zcash-in-rust-instead-of-tweets/56164)

### Gem Wallet
Wallet multichaîne, open source et en auto-garde, qui prend en charge l’envoi, la réception et l’échange de ZEC.  
[Visiter](https://gemwallet.com/)

### TIPZ
Plateforme de pourboires en direct non dépositaire où chaque pourboire arrive sous forme de ZEC protégé. Prend en charge les rampes d’accès cross-chain via NEAR Intents.  
...
## Explorateurs, données et tableaux de bord réseau
...
### Exblo
Explorateur de blocs conçu pour tester des transactions sur le Zcash Testnet.  
[Visiter](https://testnet.exblo.app/)

### OpenZcash
Tableau de bord public de transparence pour le Zcash Dev Fund, incluant la comptabilité des subventions ZCG et FPF, le Lockbox, la gouvernance et les décaissements.  
...
### Zcash.Space
Analyseur de Unified Address Zcash dans le navigateur pour inspecter les Unified Address.  
[Visiter](https://zcash.space/)

### ZecMap
Carte mondiale des commerces et lieux qui acceptent Zcash.  
...
### ZcashNames
Noms lisibles par l’humain pour les adresses protégées Zcash (par ex. `alice.zec` se résout en Unified Address).  
[Visiter](https://www.zcashnames.com/)

### Zapp / JustZappIt
Messagerie axée sur la confidentialité qui relie les discussions ZEC aux paiements du monde réel.  
[Visiter](https://www.justzappit.xyz/)

### Zentat
Extension de navigateur qui convertit les prix en monnaie fiduciaire en ZEC en temps réel pendant que vous naviguez sur le web.  
[Visiter](https://chromewebstore.google.com/detail/zentat/lpndbahladndclecodadoljlplfaldac)

### Shielded Wall
Plateforme de confessions anonymes alimentée par la confidentialité de Zcash.  
[Visiter](https://shieldedwall.org/)

### Ztrash
Boîte de réception email jetable payée en ZEC protégé.  
...
### aftok
Modèle d’organisation d’entreprise coopératif et ascendant construit sur Zcash.  
...
### Rhea Finance
Passerelle Zcash offrant un wallet de navigateur et un accès DeFi cross-chain.  
[Forum](https://forum.zcashcommunity.com/t/rhea-finance-zcash-gateway-browser-wallet-cross-chain-defi/55073)

### BazaarSwap
DEX natif à Zcash qui intègre le ZEC protégé dans la DeFi Web3 via WalletConnect.  
...
## Organisations & laboratoires

### Shielded Labs
Organisation indépendante de soutien à Zcash, financée par des dons et basée en Suisse. Première organisation de l’écosystème à n’avoir jamais reçu de financement du Development Fund ni des récompenses de bloc.  
[Visiter](https://shieldedlabs.net/)

### Cypherpunk
Entreprise dédiée à la confidentialité, à la souveraineté individuelle et aux valeurs cypherpunk. Elle crée des outils pour les personnes qui doivent protéger leur vie numérique.  
