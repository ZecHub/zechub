...
|----------------------------|----------------------------------------------------------|------|
Jinsi Zcash kazi. Kujenga mfano wa kufanya kazi ya Zcash. [Ziara ->](https://community.pgpz.org/zec-shelf/how-zcash-works.html#top) |
Max Desalle: Kujifunza Zcash. [Ziara ->](https://maxdesalle.com/mastering-zcash/) |
Mike Rosulek: Furaha ya Cryptography. [Ziara ->](https://joyofcryptography.com/) |
James Katz: Maandishi binafsi na mawazo juu ya Zcash na faragha. [Ziara ->](https://free2z.cash/James_Katz/) |
...
Sqribbles. Creative na jamii inayotokana Zcash maudhui. [Ziara ->](https://free2z.cash/sqribbles) |
Str4d: Maandishi ya kiufundi kutoka Zcash msingi developer. [Ziara ->](https://words.str4d.xyz/) |
 CipherScan Weekly  Machapisho ya kila wiki kwenye blogu yanayozungumzia uchambuzi wa blockchain za Zcash. [Ziara ->](https://cipherscan.app/) |
Zcash Shielded News. faragha ya kila wiki na mazingira habari digest. [Ziara ->](https://zechub.substack.com/) |
 ZecHub DAO Blog  makala na maudhui ya elimu kutoka kwa jamii za ZECHUB DAO. [Ziara ->](https://zechub.wiki) |
