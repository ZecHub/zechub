...
# Faragha Nzuri Sana (PGP)

Pretty Good Privacy (PGP) ni kifurushi cha programu ya cryptographic ambayo hutoa mawasiliano salama juu ya njia zisizo salama. PGP hutumia mchanganyiko wa usimbuaji na saini za dijiti ili kuhakikisha kuwa mpokeaji anayetarajiwa tu ndiye anayeweza kusoma ujumbe na kwamba mtumaji ni nani wanasema ni.

## Vifaa Vinavyopatikana

Kuna zana nyingi tofauti za PGP zinazopatikana, lakini baadhi ya maarufu zaidi ni pamoja na:

* **[GPG](https://gpgtools.org/)**: GPG ni bure na wazi chanzo PGP utekelezaji ambayo inapatikana kwa Windows, MacOS, na Linux.
...
Kwa kutumia PGP, unahitaji kuzalisha jozi ya funguo: Jinsi ya kuzalishwa funguo PGP:

1. Fungua programu yako ya PGP.
2. Bonyeza juu ya "Generate Key" kifungo.
3. Ingiza jina lako na anwani ya barua pepe.
4. Chagua urefu wa ufunguo. Urefu wa kifunguo unapoongezeka, ndivyo funguo zako zitakavyokuwa salama zaidi.
5. Bonyeza juu ya "kuzalisha" kifungo.
...
Hapa ni baadhi ya mazoea bora kwa ajili ya kutumia PGP:
...
* Weka programu yako ya PGP updated. Programu ya PPG ni daima kuwa updated kurekebisha mende na kuboresha usalama. Ni muhimu kuweka programu yako updated kuhakikisha kwamba wewe ni kutumia vipengele vya usalama karibuni.

## Jinsi ya encrypt barua pepe na PGP

* Fungua programu yako ya PGP.
* Fungua barua pepe unataka encrypt.
* Bonyeza juu ya "Encrypt" kifungo.
* Ingiza ufunguo wa umma wa mpokeaji.
* Bonyeza juu ya "Encrypt" kifungo.
...
* Fungua programu yako ya PGP.
* Fungua barua pepe iliyofichwa.
* Bonyeza juu ya "Decrypt" kifungo.
* Ingiza ufunguo wako wa kibinafsi.
* Bonyeza juu ya "Decrypt" kifungo.
