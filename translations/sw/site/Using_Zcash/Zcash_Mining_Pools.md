# Zcash Mining Pools (Vyumba vya Uchimbaji wa Fedha)

## Ni nini Zcash Mining Pools?

Hifadhi za madini ya Zcash ni huduma ambazo huruhusu wachimbaji wa kibinafsi kuchanganya nguvu zao za kompyuta (hashrate). Kwa kuunganisha rasilimali, washiriki huongeza nafasi yao ya kutatua vitalu vya mtandao na kupata malipo thabiti, ndogo badala ya kutegemea mfumo usioweza kutabirika wa uchimbaji peke yake.

---

## Orodha ya Zcash Mining Pools:

---

### [Bwawa la Maji Machafu (Brain's Pool)](https://braiins.com/pool)
...
- Tovuti: [Bwawa la Maji Machafu (Brain's Pool)](https://braiins.com/pool)
- Malipo binafsi: YES
- Aina ya Pool: Kulipa kwa Hisa
- Pool ada: 2% ya
...
- Tovuti: [FlyPool](https://zcash.flypool.org/)
- Malipo binafsi: YES
- Aina ya Pool: Kulipa kwa Mwisho N 
- Pool ada: 1% ya

---

### [2Wachimbaji wa Madini](https://zec.2miners.com/)
...
- Tovuti: [2Wachimbaji wa Madini](https://zec.2miners.com/)
- Malipo binafsi: Hapana
- Aina ya Pool: Kulipa kwa Mwisho N 
- Pool ada: 1% ya

---

### [Nanopole](https://zec.nanopool.org/login)
...
- Tovuti: [Nanopole](https://zec.nanopool.org/login)
- Malipo binafsi: Hapana
- Aina ya Pool: Kulipa kwa Mwisho N 
- Pool ada: 1% ya
...
### [Mvua ya maji](https://www.poolin.com/)
...
- Tovuti: [Mvua ya maji](https://www.poolin.com/)
- Malipo binafsi: Hapana
- Aina ya Pool: Kulipa kwa Hisa
- Pool ada: 3%
...
### [Mto wa Chungu](https://v3.antpool.com/home)
...
- Tovuti: [Mto wa Chungu](https://v3.antpool.com/home)
- Malipo binafsi: Hapana
- Aina ya Pool: Kulipa kwa Hisa
- Pool ada: 3%
...
- Tovuti: [ViaBTC](https://www.viabtc.com/en/)
- Malipo binafsi: Hapana
- Aina ya Pool: Kulipa kwa kila hisa +
- ada ya pool: 4%
...
- Malipo binafsi: Hapana
- Aina ya Pool: Kulipa kwa Mwisho N Hisa
- Ushirika wa ushirika: 0%
...
- Tovuti: [Foundry Zcash Mining Pool](https://foundrydigital.com/foundry-zcash-pool/)
- Malipo binafsi: Hapana
- Aina ya Pool: Kulipa kwa Mwisho N Hisa
- Pool ada: Si Umma
...
### [supernova](https://zec.suprnova.cc/)
...
- Tovuti: [supernova](https://zec.suprnova.cc/)
- Malipo binafsi: Hapana
- Aina ya Pool: Kulipa kwa Mwisho N Hisa
- Ushirika wa makusanyo: 0,5% - 1%

---

### [NiceHash (Usafi wa Kijani)](https://www.nicehash.com/blog/post/how-to-start-mining-zec-equihash-on-nicehash)
...
- Tovuti: [NiceHash (Usafi wa Kijani)](https://www.nicehash.com/blog/post/how-to-start-mining-zec-equihash-on-nicehash)
- Malipo binafsi: kulipwa katika Bitcoin (BTC)
- Aina ya Pool: Hashrate Marketplace / Proxy pool
- Ushirika wa makusanyo: 0,5% - 1%

---

### [Sovright Madini Pool](https://mining.sovright.com/)
...
- Tovuti: [Sovright Madini Pool](https://mining.sovright.com/)
- Malipo binafsi: YES
- Aina ya Pool: Pay Per Last N Shares (PPLNS)
- Pool Fee: 1% ya
