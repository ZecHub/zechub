...
**[KITUO cha reli](https://railgun.org/)** Kama mkataba wa smart layer-1,Railgun ipo kuwa uhamisho binafsi na miundombinu ya DeFi kutokana na kuwepo kwake kwa Ethereum, Polygon, Binance Smart Chain, na Arbitrum.
Kuanzisha yako non-matayarisho RAILGUN Wallet, Shield yoyote ERC-20 ishara katika 0zk anwani ya uchaguzi wako, Mara kulindwa, tokens, mizani, na shughuli ni encrypted - [Whitepaper](https://docs.railgun.org/wiki) 
...
**[Mtandao wa Manta](https://www.manta.network/):** On-Chain Privacy for Web 3, DeFi and more. Manta Atlantic, the fastest ZK L1 chain, brings programmable privacy to web3 through compliant on-chain privacy and identity. $MANTA ina usambazaji wa kudumu wa 1,000,000,000 bila ratiba ya mfumuko wa bei. Tokeni za $MANTa zitachomwa kiotomatiki mara tu zitakapofutwa - [Whitepaper](https://docs.manta.network/) 
...
Kwa mfano, fikiria orodha ya NFT kwenye Solana; hali yake ya umma (kwa mfano, bei) inaonekana kwa wote, pamoja na ukweli kwamba iko juu ya kuuza. Lakini ofa na biashara zinapaswa kubaki za kibinafsi - ** Kubadilishana Mali**: Ndio - [Whitepaper](https://shield.lightprotocol.com/) - ![Light Shield Logo](/content-images/1-C4Pe23afCwS05seCeZWBLA-d85910d03f.webp)
***

**[Ficha Mtandao](https://conceal.network/wiki/doku.php)**: The Conceal Network was built to provide the ability for individuals to communicate and financially interact with each other in an anonymous and decentralized manner. With Conceal, transactions can't be linked between the sender and the recipient. Additionally, Conceal uses ring signatures and one-time addresses for truly anonymous payments - **Asset Swap**: Yes - [Whitepaper](https://conceal.network/wiki/doku.php) - ![Conceal.png](/content-images/media_articles_01-ecae30ec1a.webp)
***
...
**[Dark.fi](https://dark.fi/)**: DarkFi ni anonymous L1 msingi zero-ujuzi, mahesabu ya pande nyingi na encryption homomorphic. Anonymous ushahidi wa hisa kuhakikisha validators zimefichwa. DarkFi inatoa mazingira kupambana fragile kujenga na kuendesha programu bila majina - ** Asset Swap**: Ndiyo - [Whitepaper](https://darkfi.org/whitepaper) - ![Darkfi.png](/content-images/0-auQOzkLMfYdoXlRy-b10ed91da5.webp)
***
