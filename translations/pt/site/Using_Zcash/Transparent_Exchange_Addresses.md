...
### Você **precisa** de um endereço TEX ao enviar fundos para um endereço Transparente usando uma carteira que não permite o envio direto para um endereço Transparente. 
Algumas carteiras simplesmente não permitem o envio direto para um endereço Transparente e **o destinatário pode não fornecer um equivalente TEX**. Por isso, **converter** de um endereço Transparente para um endereço TEX pode ser necessário por vezes. Isto pode ser feito manualmente executando a implementação de referência descrita na [zip-320](https://zips.z.cash/zip-0320#reference-implementation).
