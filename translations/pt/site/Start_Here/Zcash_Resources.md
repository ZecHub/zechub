...
Há vários recursos que ajudam os usuários a entender Zcash.

**[Mídia Zcash](https://www.youtube.com/c/ZcashMedia)**
...
Outro repositório no GitHub que hospeda projetos da Zcash Foundation, incluindo [zebra](https://github.com/ZcashFoundation/zebra), uma implementação de nó Zcash em Rust.

**[Halo2](https://zcash.github.io/halo2/index.html)**

Os conceitos por trás dos sistemas de provas de conhecimento zero.

**[Documentação RPC de Zcash](https://zcash.github.io/rpc/)**

Lista de todos os comandos atuais do zcashd.
