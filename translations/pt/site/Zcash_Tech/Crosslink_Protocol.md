...
Pode explorar os detalhes técnicos e acompanhar o seu progresso através do [repositório zebra-crosslink no GitHub](https://github.com/ShieldedLabs/zebra-crosslink) e de [O Livro zebra-crosslink](https://shieldedlabs.github.io/zebra-crosslink/).
