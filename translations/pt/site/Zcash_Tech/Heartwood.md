...
| Coinbase transaction | A transação especial em cada bloco que paga a recompensa do bloco |
| Shielded Sapling address | Um tipo de endereço privado da Zcash introduzido pela atualização Sapling |
