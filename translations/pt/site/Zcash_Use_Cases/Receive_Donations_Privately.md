...
- Use um endereço **blindado (z)**
- Nunca compartilhe publicamente um endereço transparente (t)
- Incentive os doadores a enviar a partir de carteiras blindadas
- Evite vincular sua identidade às transações
...
- Qualquer pessoa que queira apoio financeiro privado
...
Isso permite que você receba fundos **sem expor seu grafo financeiro**.
...
Isso geralmente começa com: `zs...`


### Etapa 2: Compartilhe apenas seu endereço blindado

- Publique seu z-address em:
  - Site
  - Redes sociais
  - Páginas de doação

**NÃO compartilhe um endereço transparente (t).**

### Etapa 3: Oriente os doadores (opcional, mas recomendado)

Incentive os doadores a:
- Usar carteiras que ofereçam suporte a transações blindadas
- Enviar a partir de pools blindados (não transparentes)

### Etapa 4: Mantenha práticas básicas de higiene de privacidade

- Evite reutilizar o mesmo endereço em identidades não relacionadas
- Não associe publicamente seu endereço à sua identidade pessoal, a menos que seja necessário
...
- Aceitar fundos de fontes transparentes sem blindá-los  
- Reutilizar o mesmo endereço em múltiplos contextos  
...
- Evitar expor sua atividade financeira
...
Você aprendeu como receber fundos de forma privada.
