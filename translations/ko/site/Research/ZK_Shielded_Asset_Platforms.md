...
**[StarkEX](https://starkware.co/starkex/):** Ethereum 메인넷에서 가동 중인 레이어 2 확장성 엔진입니다. 거래는 오프체인에서 배치 처리되어 StarEX 서비스로 전송됩니다. StarEX는 거래를 검증하고 관련 잔액을 업데이트하며, 거래의 유효성을 바탕으로 STARK 증명을 생성합니다. 온체인 검증자 스마트 계약이 STARK 증명을 받아 검증합니다 - [백서](https://docs.starkware.co/starkex-v4/)
...
**[Namada](https://namada.net/testnets)**: 요약: Namada는 체인 간 자산 중립적 프라이버시를 위한 지분증명 기반 레이어 1입니다. Namada는 IBC를 통해 빠른 확정성을 가진 체인들과, 신뢰 불필요한 양방향 브리지를 통해 Ethereum과 기본적으로 상호운용됩니다. 프라이버시를 위해 Namada는 다중 자산 Shield 풀(MASP) 회로의 업그레이드 버전을 도입하여 모든 자산(대체 가능 및 대체 불가능)이 공통된 Shield 집합을 공유할 수 있게 합니다. 이렇게 하면 CryptoKitty를 전송하는 것이 ETH, DAI, ATOM, OSMO, NAM(Namada의 기본 자산) 또는 Namada의 다른 어떤 자산을 전송하는 것과 구별되지 않습니다. **자산 스왑**: 예 - [백서](https://docs.namada.net/) - ![Namada.png](/content-images/y4D30_VO_400x400-312a479be4.webp)
***
...
**[Ironfish Network](https://ironfish.network/)**: Ironfish는 모든 거래를 암호화하여 민감한 자산 정보를 공개 시야로부터 Shield합니다. 읽기 전용 뷰 키를 통해 사용자는 규정을 준수하면서도 통제권을 유지할 수 있습니다. Iron Fish는 작업증명(PoW) 기반의 탈중앙화 레이어 1 블록체인으로, 검열 저항성과 공개 접근성을 갖춘 블록체인 프로젝트입니다. 이는 모든 거래에 강력한 프라이버시 보장을 제공하도록 설계되었습니다 - **자산 스왑**: 예 - [백서](https://ironfish.network/learn/whitepaper) - ![Ironfish.png](/content-images/kxDDjheA_400x400-2aca14fa6f.webp)
***
...
**[Zano](https://zano.org/)**: Zano는 레이어 1 솔루션이자 기업급 프라이버시, 보안, 확장성을 갖춘 오픈소스 암호화폐 및 생태계로, 기밀 자산과 탈중앙화 애플리케이션(dApps)을 위한 견고한 기반으로 작동합니다. 여러분의 프라이버시는 중요합니다. 기밀성과 보안을 우선시하는 선도적인 블록체인 플랫폼 Zano를 선택하세요. Zano 네트워크 참여자 간 거래는 링 서명과 스텔스 주소를 통해 추적 불가능하게 이루어집니다. 또한 블록체인에 거래 데이터가 저장되는 방식은 거래를 승인한 당사자만 접근할 수 있게 하며, 어떤 프라이빗 데이터도 공개적으로 게시되지 않습니다. 모든 Zano 거래의 기밀성은 코어에 하드코딩되어 있습니다. 모든 송금 및 수신 주소를 숨김으로써 모든 Zano 사용자에 대한 프라이버시 수준을 극대화했습니다 - **자산 스왑**: 예 - [백서](https://docs.zano.org/) - ![Zano.png](/content-images/FrSPUjYWIAMMWGJ-404fe8a085.webp)
***
...
**[Secret Network](https://scrt.network/)**: Secret Network는 Cosmos SDK를 사용해 구축된 레이어 1 블록체인이며, 더 넓은 상호연결된 Cosmos 세계(IBC)의 일부입니다. Secret Network는 프라이버시 보존형 스마트 계약을 갖춘 최초의 메인넷 블록체인으로 2020년에 출시되었습니다. 이를 통해 탈중앙화되고 무허가적이면서도 프라이빗한 앱을 구축할 수 있습니다 - **자산 스왑**: 예 - [백서](https://docs.scrt.network/) -
