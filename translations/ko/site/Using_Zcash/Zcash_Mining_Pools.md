...
Zcash 채굴 풀은 개별 채굴자들이 자신의 컴퓨팅 파워(해시레이트)를 결합할 수 있게 해주는 서비스입니다. 자원을 함께 모으면 참여자들은 네트워크 블록을 해결할 확률을 높일 수 있으며, 솔로 채굴의 예측 불가능한 복권형 시스템에 의존하는 대신 더 작지만 일관된 보상을 얻을 수 있습니다.
...
- 비공개 지급: Bitcoin (BTC)으로 지급
- 풀 유형: Hashrate Marketplace / Proxy Pool
- 풀 수수료: 0,5% - 1%
...
- 웹사이트: [Sovright Mining Pool](https://mining.sovright.com/)
- 비공개 지급: 예
- 풀 유형: Pay Per Last N Shares (PPLNS)
- 풀 수수료: 1%
