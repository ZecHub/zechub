...
- 기능: 주소록 | CrossPay | Near Intents | Flexa 결제 | 다중 서명 | 결제 요청 | 실드 메모 | 동기화 전 지출 | TEX 주소 | Tor 지원 | F-droid
- Ironwood: 준비됨
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address | 하드웨어
- 풀: 투명 | Sapling | Ironwood
- 기능: 주소록 | 콜드 스토리지 | 다변화 주소 | 결제 요청 | 풀 전송 | 실드 메모 | TEX 주소 | 투표 | WarpSync
- Ironwood: 준비되지 않음
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address
- 풀: 투명 | Sapling | Ironwood
- 기능: 주소록 | 재무 인사이트 | 결제 요청 | PepperSync | 실드 메모 | 테스트넷 지원
- Ironwood: 준비됨
...
- 풀: 투명 | Sapling
- 기능: 자동 실드 | DEX 스왑 | 멀티 코인 | 실드 메모 | 동기화 전 지출
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address
- 풀: 투명 | Sapling | Ironwood
- 기능: 주소록 | 주소 확인 | 자동 실드 | 다변화 주소 | 결제 요청 | 실드 메모 | TEX 주소 | 테스트넷 지원
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address | 하드웨어
- 풀: 투명 | Sapling | Ironwood
- 기능: 주소 순환 | 광범위한 키 지원 | 암호화된 내보내기 | FROST 다중 서명 | 다중 계정 동기화 | 실드 메모 | 테스트넷 지원
- Ironwood: 준비됨
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address
- 풀: 투명 | Sapling | Ironwood
- 기능: 주소록 | 주소 순환 | 자동 실드 | DEX 스왑 | 멀티 코인 | 실드 메모 | Tor 지원
- Ironwood: 준비됨
...
- 풀: 투명 | Sapling | Ironwood
- 기능: 주소록 | 그래픽 인터페이스 | 실드 메모 | 테스트넷 지원
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address | 풀 노드
- 풀: 투명 | Sapling | Ironwood
- 기능: 명령줄 인터페이스 | PepperSync | 실드 메모 | 테스트넷 지원
- Ironwood: 진행 중
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address | 풀 노드
- 풀: 투명 | Sapling | Ironwood
- 기능: 알파 릴리스 | JSON-RPC 인터페이스 | 실드 메모 | 테스트넷 지원
- Ironwood: 준비됨
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address | 풀 노드
- 풀: 투명 | Sapling | Ironwood
- 기능: 명령줄 인터페이스 | 다변화 주소 | 실드 메모 | 테스트넷 지원
- Ironwood: 준비되지 않음
...
- 풀: 투명 | Sapling | Ironwood
- 기능: 자동 실드 | 실드 메모 | 테스트넷 지원 | FROST 다중 서명
- Ironwood: 준비됨
...
- 운영 체제: 브라우저
- 풀: 실드 | 투명
- 기능: 브라우저 확장 프로그램 | 실드 거래 | 크로스체인 스왑 | 대출 및 차입 | DApp 연결 | Rhea
- Ironwood: 준비됨
...
- 풀: Sapling | 투명
- 기능: 멀티 코인 | Near Intents | Maya DEX | KYC 없음 | 비수탁형 | 웹 앱 | 데스크톱 앱 | 실드 ZEC | AnyPay
- Ironwood: 준비됨
...
- 기능: 암호화된 메모 | 지갑 백업(지갑 데이터) | RPC 인터페이스 | 실드 메모 | 개인 키 관리
- Ironwood: 준비됨
...
- 기기: 모바일 | 데스크톱
- 운영 체제: iOS | macOS
- 지갑 지원: 시드 문구 | 패스키 | Unified Address | 개인 키 | 자기 수탁 지갑
- 풀: 투명 | Sapling | Ironwood
- 기능: 자기 수탁 | 로컬에 저장된 개인 키 | KYC 불필요 | 지갑 활동을 위한 Zend 서버 의존성 없음 | 암호화된 실드 거래 | 시드 복구 | 실드 메모 | 패스키 인증
...
- 풀: 투명 | Sapling | Ironwood
- 기능: 주소록 | Tor 지원 | I2P 지원 | Zebra/zebrad 통합 | 거래 내역 | 거래 내보내기 | 로컬 증인 도출 | 동적 수수료 (ZIP-317) | NU6.2 호환성 | NU6.3 마이그레이션 지원 | 실드 메모
- Ironwood: 준비됨
...
- 지갑 지원: 시드 문구 | Viewing Key | Unified Address | 다중 계정 지갑 | 자기 수탁 지갑 | 개인 키 관리 | 에이전트 지갑 지원
- 풀: 투명 | Sapling | Ironwood
- 기능: NEAR Intents | 결제 요청 | 실드 메모 | 기본 실드 거래 | 테스트넷 | 크로스체인 스왑 | CipherPay | Viewing Key | AI 에이전트 | MCP 서버 | CLI 지갑 | FROST | 베타
- Ironwood: 진행 중
...
- 풀: 투명 | Sapling | Ironwood | Sprout
- 기능: 지갑 복구 | 명령줄 인터페이스 | 실드 메모 | 테스트넷 지원
- Ironwood: 준비됨
