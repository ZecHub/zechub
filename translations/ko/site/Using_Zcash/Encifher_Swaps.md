...
### 단계 3: Zodl 지갑 준비  
ZODL에서 관리하는 Zcash 지갑인 [**Zodl**](https://zodl.com)을 다운로드하세요. 수신 탭에서 **Unified Address**를 복사합니다. 이 주소는 투명하고 보호된 ZEC 모두를 지원합니다. 계속하기 전에 시드 구문을 안전하게 저장하세요.
...
Solana의 속도, Zcash의 프라이버시, NEAR Intents의 자동화 기능을 결합한 **encrypt.trade**는 암호화폐 스왑이 무엇인지 다시 정의합니다. 빠르고 매끄럽고 진정으로 비밀 유지되는 스왑입니다.
