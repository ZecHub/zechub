...
Zcash를 이해하는 데 도움이 되는 다양한 자료가 있습니다.
...
또 다른 GitHub 저장소로, Zcash 재단의 프로젝트들을 호스팅합니다. 이 중에는 Rust로 작성된 [zebra](https://github.com/ZcashFoundation/zebra)와 같은 Zcash 노드 구현도 포함되어 있습니다.

**[Halo2](https://zcash.github.io/halo2/index.html)**

제로 지식 증명 시스템의 개념들에 대한 설명입니다.

**[Zcash RPC Docs](https://zcash.github.io/rpc/)**

zcashd에 대한 모든 현재 명령어 목록입니다.
