# <img src="/content-images/shopping-cart-free-15-svgrepo-com-991c5b52e9.svg" width="24" height="24" alt="finance icon"/> 상인으로서 Zcash를 사용해 결제 수락하기
...
전통적인 암호화폐 결제는 다음과 같은 정보를 노출시킵니다:
- 고객의 구매 행동
- 상인의 수익
- 거래 내역
...
이제 사업용으로 비공개 결제 흐름을 실행할 수 있습니다.
