...
- 공유 자금을 보호된 주소로 보관하세요.
- 잔액과 거래 내역의 가시성을 제한하세요.
- 운영 역할을 공개 신원에서 분리하세요.
- 내부 책임감을 위해 메모를 사용하세요.
...
공개 신원과 연결되지 않도록 주의하세요.

### 단계 3: 비공개 자금 수령

- 보호된 주소를 통해 기여를 받으세요
- 기여자에게 보호된 지갑에서 보내도록 권장하세요
...
- 보호된 거래를 통해 자금을 이동 (z → z)
- 수령자의 신원을 공개하지 않도록 주의하세요
