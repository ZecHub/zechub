# <img src="/content-images/journalist-host-profession-interview-svg-2eb63ae5c9.svg" width="24" height="24" alt="기자 아이콘"/> 기자의 프라이버시 설정 방법: Zcash 사용
...
- 모든 거래에 대해 쉴드 주소를 사용하세요.
- 지갑 식별자를 공개적으로 노출하지 마세요.
- 추적 가능한 결제를 피하여 소스를 보호하세요.
- 안전한 의사소통을 위해 메모를 신중하게 사용하세요.

<br/>

## <img src="/content-images/user-svgrepo-com-21adf62b7c.svg" width="24" height="24" className="inline-block align-middle mr-1 p-[2px]" alt="사용자 아이콘"/> 이 가이드는 누구에게 적합한가요?
...
기자는 다음과 같은 위험에 직면합니다:
- 감시
- 소스 노출 가능성
- 적대자에 의한 재정 추적

투명한 암호화폐를 사용하면 다음이 드러날 수 있습니다:
- 누가 당신에게 지불했는지
- 당신이 누구에게 지불했는지
- 언제, 얼마나 지불했는지
...
- 쉴드 기능을 지원하는 Zcash 지갑
- 블록체인 외부의 안전한 의사소통 채널
- 운영적 자세
...
- 메모에 민감한 정보를 포함하지 마세요.
- 필요할 경우 중립적 또는 암호화된 참조를 사용하세요.

### 단계 5: 운영 보안 유지

- 지갑을 본인의 정체성과 연결하지 마세요.
- 거래를 공개적으로 확인하지 마세요.
- 의사소통에 별도 채널을 사용하세요.
...
## <img src="/content-images/celebration-spark-svgrepo-com-bc98dec7c1.svg" width="24" height="24" className="inline-block align-middle mr-1 p-[2px]" alt="축하 아이콘"/> 완료

**6단계 중 6단계 — 완료**

Zcash 사용의 가장 고급 수준에 도달했습니다.
...
- [홈 페이지로 이동](/)
- [개발자 경로 탐색](/developers)
- [ZecHub에 기여하기](/contribute/help-build-zechub)
