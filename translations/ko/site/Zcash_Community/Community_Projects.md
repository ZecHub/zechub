...
### ZECPublish
검열 저항성을 갖춘, Zcash 블록체인 기반 소셜 미디어입니다. Zcash 사용자 디렉터리와 익명 메시지 보드도 포함합니다.  
...
### Zectastic
Zcash 테마 게임과 실시간 커뮤니티 이벤트를 제공하는 인터랙티브 사이트입니다.  
...
### Zcash Grants Hub
Zcash 보조금이 어떻게 발견되고, 추적되며, 검토되는지를 단순화하도록 설계된 커뮤니티 중심 보조금 대시보드입니다. Zcash Community Grants GitHub 저장소에서 실시간 데이터를 가져와 보조금 신청서, 마일스톤, 예산, 토론, 분석을 한곳에 모읍니다. 이 플랫폼은 신청자, 위원회 구성원, 커뮤니티 검토자에게 더 명확하고 사용자 친화적인 경험을 제공하는 것을 목표로 합니다.

[방문하기](https://staging.zgrantshub.com/)
...
### Zimppy
Zcash용 Machine Payment Protocol (MPP)입니다. AI 에이전트와 자동화된 기계 간 워크플로를 위해 설계되었습니다. 완전 실드 Orchard 결제를 지원합니다.  
[방문하기](https://zimppy.xyz/)

### Dizzy Wallet
Zcash 트랜잭션에 원활하고 안전하게 접근할 수 있게 해주는 Discord 봇입니다.  
...
### ZecVault
Zcash 실드 트랜잭션 위에 구축된 목표 기반 저축 지갑입니다.  
...
### MonteZecret
Rust로 작성된 Zcash용 실험적 경량 데스크톱 지갑입니다.  
...
### Zlink
Zcash 생태계에 관한 링크, 도구, 정보를 찾기 위한 디렉터리입니다.  
[방문하기](https://zlink.click)

### Zecmarket
Zcash 생태계의 프라이버시 우선 마켓플레이스입니다. 결제는 직접 정산되며 플랫폼은 사용자의 자금을 보관하지 않습니다.

[방문하기](https://zecmarket.org/)
...
### Cypherpunk
프라이버시, 자기주권, cypherpunk 가치에 전념하는 회사입니다. 디지털 삶을 보호해야 하는 개인을 위한 도구를 만듭니다.  
