# Mining Pool di Zcash

## Cosa sono i mining pool di Zcash?

I mining pool di Zcash sono servizi che permettono ai singoli miner di combinare la propria potenza di calcolo (hashrate). Mettendo in comune le risorse, i partecipanti aumentano le proprie probabilità di risolvere i blocchi della rete e guadagnano payout costanti e più piccoli, invece di affidarsi all'imprevedibile sistema a lotteria del solo mining.

---

## Elenco dei mining pool di Zcash:
...
- Payout privati: No
- Tipo di pool: Pay Per Last N Shares
- Commissione del pool: Non pubblica
