...
# RPi5 Zebra Lightwalletd із Zingo
...
## Синхронізуйте lightwalletd

* зверніть увагу на зміну data-dir
...
```
Якщо у вас виникнуть помилки, [тут](https://www.digitalocean.com/community/tutorials/how-to-install-node-js-on-ubuntu-22-04) наведено кілька альтернативних способів встановлення NodeJS.
...
* Можна використовувати appimage або бінарний файл у розпакованій папці
* Насолоджуйтесь! :)
