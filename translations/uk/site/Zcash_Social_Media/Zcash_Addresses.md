...
Ця гілка спочатку вказувала на **Ywallet** через план транзакції, який вона показувала перед тим, як ви натиснете «надісллати». Ywallet більше не підтримується й не буде оновлена для Ironwood, тому вона більше не може стежити за ланцюгом. Натомість оберіть підтримуваний гаманець зі сторінки [Гаманці](https://zechub.wiki/wallets) і надайте перевагу тому, який повідомляє вам, що розкриє транзакція, перш ніж її буде надіслано.
