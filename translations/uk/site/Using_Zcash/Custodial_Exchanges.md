...
- Пари: ALL/ZEC
- Підтримує: Transparent (депозит на TEX Address)
...
- Підтримує: Transparent | Shielded (депозит і виведення на z-address)
- Час депозиту: Миттєво (non-custodial swap)
___
...
- Пари: ALL/ZEC
- Підтримує: Transparent | Shielded виведення
