...
Існує низка ресурсів, які допомагають користувачам зрозуміти Zcash.

**[Медіа Zcash](https://www.youtube.com/c/ZcashMedia)**
...
Ще один репозиторій GitHub, у якому розміщено проєкти Zcash Foundation, зокрема [zebra](https://github.com/ZcashFoundation/zebra), реалізацію вузла Zcash на Rust.

**[Halo2](https://zcash.github.io/halo2/index.html)**

Концепції, що лежать в основі систем доказів з нульовим розголошенням.

**[Документація RPC Zcash](https://zcash.github.io/rpc/)**

Список усіх поточних команд для zcashd.

_Це незавершений документ_
