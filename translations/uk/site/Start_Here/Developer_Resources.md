...
**Список рекомендованих ресурсів для нових розробників у Zcash**

Широкий огляд того, як працюють блокчейни та Zcash:
...
Формування розуміння того, як команди перевіряють і підтримують залежності:
...
[Клієнт Arti ToR на Rust](https://docs.rs/arti/latest/arti/)
