...
[**Zodl**](https://zodl.com) डाउनलोड करें, जो ZODL द्वारा संचालित Zcash wallet है। Receive tab से अपना **Unified Address** कॉपी करें - यह transparent और shielded दोनों प्रकार के ZEC का समर्थन करता है। आगे बढ़ने से पहले अपनी seed phrase को सुरक्षित रूप से सहेज लें।
