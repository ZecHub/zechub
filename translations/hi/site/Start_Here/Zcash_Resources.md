...
ऐसे कई संसाधन हैं जो उपयोगकर्ताओं को Zcash को समझने में मदद करते हैं।
...
एक और GitHub repository जो Zcash Foundation की परियोजनाओं को होस्ट करती है, जिनमें [zebra](https://github.com/ZcashFoundation/zebra) भी शामिल है, जो Rust में Zcash node implementation है।

**[Halo2](https://zcash.github.io/halo2/index.html)**

zero-knowledge proof systems के पीछे की अवधारणाएँ।

**[Zcash RPC Docs](https://zcash.github.io/rpc/)**

zcashd के सभी वर्तमान commands की सूची।

_यह एक अधूरा दस्तावेज़ है_
