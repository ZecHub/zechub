...
ZecHub में कोई भी योगदान [ZecHub स्टाइल गाइड](https://zechub.wiki/contribute/style-guide) का पालन करना चाहिए। इसमें विकी, दस्तावेज़ और सोशल मीडिया सामग्री शामिल हैं।
...
ये काफी व्यापक क्षेत्र हैं, इसलिए काम करने के लिए बहुत कुछ है। यदि आपको कुछ प्रेरणा चाहिए, तो हमारी वर्तमान [wiki-docs साइट](https://zechub.wiki/) देखें और देखें कि क्या कमी है। जब आप तय कर लें कि आप क्या लिखना चाहते हैं, तो अपने बदलाव करना शुरू करें और सीखें कि ZecHub repo में PR कैसे submit करना है। हमारे सभी docs इसी repo में बनाए और संधारित किए जाते हैं। wiki page लिखते समय [ZecHub स्टाइल गाइड](https://zechub.wiki/contribute/style-guide) का पालन करें, और संरचनात्मक संदर्भ के लिए उसी section में मौजूद किसी मौजूदा page का उपयोग करें। PR submit करने के बाद, कृपया discord के #zechub section में @dismad, @squirrel, या @vito को संदेश भेजें, और वे आपके PR की समीक्षा करेंगे तथा यदि वह साइट में जोड़ने के लिए तैयार होगा तो उसे merge करेंगे। यदि merge हो जाता है, तो वे doc को ZecHub website में जोड़ देंगे। यदि doc तैयार नहीं है, तो वे PR में आपके लिए edits सुझाएँगे।
