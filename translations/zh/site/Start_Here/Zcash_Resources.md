...
**[Zcash 媒体](https://www.youtube.com/c/ZcashMedia)**
...
这是另一个托管 Zcash Foundation 项目的 GitHub 仓库，其中包括 [zebra](https://github.com/ZcashFoundation/zebra)，一个使用 Rust 编写的 Zcash 节点实现。

**[Halo2](https://zcash.github.io/halo2/index.html)**

零知识证明系统背后的概念。

**[Zcash RPC 文档](https://zcash.github.io/rpc/)**
