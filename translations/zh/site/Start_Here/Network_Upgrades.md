...
日期均以 UTC 显示。有些仪表盘会以本地时间显示，但对应的是同一个区块和同一时刻。每次升级的固定触发条件都是其激活区块高度，而不是日历日期：Ironwood 在区块 3,428,143 激活。未来的升级 NU7 仍在规划中，与 Ironwood 不是一回事。
