...
- 功能：地址簿 | CrossPay | Near Intents | Flexa 支付 | 多重签名 | 支付请求 | 屏蔽备忘录 | 同步前消费 | TEX 地址 | Tor 支持 | F-droid
- Ironwood：已就绪
...
- 钱包支持：助记词 | Viewing Key | Unified Address | 硬件
- 资金池：透明 | Sapling | Ironwood
- 功能：地址簿 | 冷存储 | 多样化地址 | 支付请求 | 资金池转账 | 屏蔽备忘录 | TEX 地址 | 投票 | WarpSync
- Ironwood：未就绪
...
- 钱包支持：助记词 | Viewing Key | Unified Address
- 资金池：透明 | Sapling | Ironwood
- 功能：地址簿 | 财务洞察 | 支付请求 | PepperSync | 屏蔽备忘录 | 测试网支持
- Ironwood：已就绪
...
- 资金池：透明 | Sapling
- 功能：自动屏蔽 | DEX 兑换 | 多币种 | 屏蔽备忘录 | 同步前消费
...
- 钱包支持：助记词 | Viewing Key | Unified Address
- 资金池：透明 | Sapling | Ironwood
- 功能：地址簿 | 地址检查 | 自动屏蔽 | 多样化地址 | 支付请求 | 屏蔽备忘录 | TEX 地址 | 测试网支持
...
- 钱包支持：助记词 | Viewing Key | Unified Address | 硬件
- 资金池：透明 | Sapling | Ironwood
- 功能：地址轮换 | 广泛密钥支持 | 加密导出 | FROST 多签 | 多账户同步 | 屏蔽备忘录 | 测试网支持
- Ironwood：已就绪
...
- 钱包支持：助记词 | Viewing Key | Unified Address
- 资金池：透明 | Sapling | Ironwood
- 功能：地址簿 | 地址轮换 | 自动屏蔽 | DEX 兑换 | 多币种 | 屏蔽备忘录 | Tor 支持
- Ironwood：已就绪
...
- 钱包支持：助记词 | Viewing Key | Unified Address | 全节点
- 资金池：透明 | Sapling | Ironwood
- 功能：命令行界面 | PepperSync | 屏蔽备忘录 | 测试网支持
- Ironwood：进行中
...
- 钱包支持：助记词 | Viewing Key | Unified Address | 全节点
- 资金池：透明 | Sapling | Ironwood
- 功能：Alpha 版本 | JSON-RPC 接口 | 屏蔽备忘录 | 测试网支持
- Ironwood：已就绪
...
- 资金池：透明 | Sapling | Ironwood
- 功能：端到端加密即时通讯工具 | NEAR Intents | P2P.me 法币出金 | Beta
- Ironwood：已就绪
...
- 功能：加密备忘录 | 钱包备份（钱包数据） | RPC 接口 | 屏蔽备忘录 | 私钥管理
- Ironwood：已就绪
...
- 设备：移动端 | 桌面端
- 操作系统：iOS | macOS
- 钱包支持：助记词 | 通行密钥 | Unified Address | 私钥 | 自托管钱包
- 资金池：透明 | Sapling | Ironwood
- 功能：自托管 | 私钥本地存储 | 无需 KYC | 钱包活动无需依赖 Zend 服务器 | 加密屏蔽交易 | 助记词恢复 | 屏蔽备忘录 | 通行密钥认证
...
- 资金池：透明 | Sapling | Ironwood
- 功能：地址簿 | Tor 支持 | I2P 支持 | Zebra/zebrad 集成 | 交易历史 | 交易导出 | 本地见证派生 | 动态费用（ZIP-317）| NU6.2 兼容性 | NU6.3 迁移支持 | 屏蔽备忘录
- Ironwood：已就绪
...
- 资金池：透明 | Sapling | Ironwood
- 功能：NEAR Intents | 支付请求 | 屏蔽备忘录 | 默认屏蔽交易 | 测试网 | 跨链兑换 | CipherPay | Viewing Key | AI Agent | MCP 服务器 | CLI 钱包 | FROST | Beta
- Ironwood：进行中
