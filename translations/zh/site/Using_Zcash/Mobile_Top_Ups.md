...
在本指南中，你将学习如何使用 ZEC 购买话费。

## 请按以下步骤操作：

### 1. 创建账户
访问 [Coinsbee.com](https://www.coinsbee.com/en/shop/mobile-top-ups/) 并创建一个账户。
...
最近，Zcash 已经出现了若干新的应用场景，使其在日常使用中更加实用。许多在线商店和商家都接受 ZEC 作为商品和服务的支付方式，尤其是那些重视隐私友好型交易的商家。  

如果你拥有一家企业并希望开始接受 ZEC 支付呢？通过 [PayWithZash](https://paywithz.cash/)，你的企业可以被添加到接受 ZEC 支付服务费用的商家名单中。
