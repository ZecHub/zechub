...
# 搭配 Zingo 的 RPi5 Zebra Lightwalletd
...
<div className="my-8 w-full aspect-video max-w-3xl mx-auto rounded-2xl overflow-hidden shadow-lg bg-black">
  <iframe
    ...
    title="使用 Zcash Zebra 节点搭配 Lightwalletd：教程"
...
```
如果你遇到任何错误，[这里](https://www.digitalocean.com/community/tutorials/how-to-install-node-js-on-ubuntu-22-04)有一些安装 NodeJS 的替代方法。
...
* 可以使用 appimage，或使用 unpacked 文件夹中的二进制文件
* 祝你使用愉快！:)
