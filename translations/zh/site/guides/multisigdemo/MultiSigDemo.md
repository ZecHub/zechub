...
>
> 关于当前 Zcash 上的多方托管，请参阅 [FROST 与门限托管](/zcash-tech/frost-threshold-custody) 以及可用的 [Ywallet FROST 演示](/guides/ywallet-frost-demo)。如需将现有节点从 zcashd 迁移，请参阅[迁移到 Zebra 和 Zallet 的指南](/guides/migration-guide-zcashd-to-zebrad-zallet)。
>
