...
> **Ywallet 已不再维护。** 其开发者已确认不会为 Ironwood (NU6.3) 更新，因此它无法再跟随链，且以下步骤无法在主网上完成。本页面仅供参考。同一开发者推出的 Zkool 是仍在维护的后继产品，并支持 FROST 多重签名。
