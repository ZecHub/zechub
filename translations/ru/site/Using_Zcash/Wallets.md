...
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Адресная книга | CrossPay | Near Intents | Платежи Flexa | Мультиподпись | Запрос платежа | Защищённое примечание | Трата до синхронизации | TEX-адрес | Поддержка Tor | F-droid
- Ironwood: Готово
...
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Адресная книга | Финансовая аналитика | Запрос платежа | PepperSync | Защищённое примечание | Поддержка тестовой сети
- Ironwood: Готово
...
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Адресная книга | Проверка адреса | Автоматическое экранирование | Диверсифицированный адрес | Запрос платежа | Защищённое примечание | TEX-адрес | Поддержка тестовой сети
...
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address | Аппаратный
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Ротация адресов | Широкая поддержка ключей | Зашифрованный экспорт | FROST-мультиподпись | Синхронизация нескольких аккаунтов | Защищённое примечание | Поддержка тестовой сети
- Ironwood: Готово
...
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Адресная книга | Графический интерфейс | Защищённое примечание | Поддержка тестовой сети
...
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address | Полный узел
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Интерфейс командной строки | PepperSync | Защищённое примечание | Поддержка тестовой сети
- Ironwood: В процессе
...
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address | Полный узел
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Альфа-версия | Интерфейс JSON-RPC | Защищённое примечание | Поддержка тестовой сети
- Ironwood: Готово
...
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address | Полный узел
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Интерфейс командной строки | Диверсифицированный адрес | Защищённое примечание | Поддержка тестовой сети
- Ironwood: Не готово
...
- Поддержка кошелька: Seed Phrase | Unified Address
- Пулы: Прозрачный | Ironwood
- Функции: Защищённое примечание | Трата до синхронизации | Поддержка тестовой сети
...
- Операционная система: Android | iOS | Windows | Linux | macOS | Браузер
- Пулы: Прозрачный
- Функции: Мультивалютность | Веб-приложение
...
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Автоматическое экранирование | Защищённое примечание | Поддержка тестовой сети | FROST-мультиподпись
- Ironwood: Готово
...
- Операционная система: Браузер
- Пулы: Защищённый | Прозрачный
- Функции: Расширение браузера | Защищённые транзакции | Межсетевые обмены | Кредитование и заимствование | Подключения DApp | Rhea
- Ironwood: Готово
...
- Поддержка кошелька: Seed Phrase | Внешний кошелёк | Адрес получения | QR-код | Аппаратный
...
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address | Приватный ключ | Ключ траты | Резервная копия кошелька / экспорт ключа | Кошелёк полного узла
- Пулы: Прозрачный | Sapling | Ironwood | Sprout
- Функции: Зашифрованное примечание | Резервная копия кошелька (данные кошелька) | Интерфейс RPC | Защищённое примечание | Управление приватными ключами
- Ironwood: Готово
...
- Поддержка кошелька: Seed Phrase | Passkey | Unified Address | Приватный ключ | Некастодиальный кошелёк
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Самостоятельное хранение | Приватный ключ хранится локально | KYC не требуется | Отсутствие зависимости активности кошелька от сервера Zend | Зашифрованная защищённая транзакция | Восстановление по seed-фразе | Защищённое примечание | Аутентификация с Passkey
...
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address | Ключ траты | HD-кошелёк | Управление приватными ключами
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: Адресная книга | Поддержка Tor | Поддержка I2P | Интеграция Zebra/zebrad | История транзакций | Экспорт транзакций | Локальное создание свидетелей | Динамическая комиссия (ZIP-317) | Совместимость с NU6.2 | Поддержка миграции NU6.3 | Защищённое примечание
- Ironwood: Готово
...
- Устройства: Мобильные | Настольные
- Операционная система: Android | Windows | Linux (CLI и MCP-сервер) | iOS | macOS
- Поддержка кошелька: Seed Phrase | Viewing Key | Unified Address | Кошелёк с несколькими аккаунтами | Некастодиальный кошелёк | Управление приватными ключами | Поддержка агентского кошелька
- Пулы: Прозрачный | Sapling | Ironwood
- Функции: NEAR Intents | Запросы платежей | Защищённое примечание | Защищённые транзакции по умолчанию | Тестовая сеть | Межсетевой обмен | CipherPay | Viewing Key | ИИ-агент | MCP-сервер | CLI-кошелёк | FROST | Бета
- Ironwood: В процессе
...
- Устройства: Настольные
- Операционная система: Windows | Linux | macOS
- Поддержка кошелька: Seed Phrase | Ключ траты | Приватный ключ | Резервная копия кошелька / экспорт ключа
- Пулы: Прозрачный | Sapling | Ironwood | Sprout
- Функции: Восстановление кошелька | Интерфейс командной строки | Защищённое примечание | Поддержка тестовой сети
- Ironwood: Готово
