...
Скачайте [**Zodl**](https://zodl.com), кошелёк Zcash, поддерживаемый ZODL. Скопируйте ваш **Unified Address** на вкладке «Получение» — он поддерживает как прозрачные, так и защищённые ZEC. Перед продолжением обязательно надёжно сохраните вашу сид-фразу.
