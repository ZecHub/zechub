...
- [Сообщить об уязвимости в zcash/zcash](https://github.com/zcash/zcash/security/policy) — заменяет адрес Electric Coin Company, на который ранее указывал этот пункт и который больше недоступен.
