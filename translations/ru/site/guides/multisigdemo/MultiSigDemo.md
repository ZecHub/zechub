...
> **Историческая страница. Это руководство больше не работает.**
>
> Все шаги ниже зависят от zcashd, который 18 июля 2026 года достиг автоматической остановки по окончании поддержки. Семь скриптов, поставляемых вместе с этой страницей, управляют им через `zcash-cli`, поэтому ни один из них сегодня не может обратиться к работающему узлу.
>
