...
Если вы впервые изучаете Zcash, то сразу поймёте, что возможны два типа [транзакций](https://zechub.wiki/using-zcash/transactions): *прозрачные* и *защищённые*.
Кроме того, если вы следите за последними событиями в экосистеме Zcash, возможно, вы уже узнали о [унифицированных адресах](https://web.archive.org/web/20260823012524/https://electriccoin.co/blog/unified-addresses-in-zcash-explained/), или UA.
Когда люди в индустрии Zcash говорят о *защищённых* транзакциях, они имеют в виду транзакции с адресами, закодированными для протоколов sapling или orchard. 
UA предназначены для объединения *любого* типа защищённой или прозрачной транзакции в одном адресе. Это обобщение — ключ к упрощению пользовательского опыта в дальнейшем. Цель этого руководства — дополнить понимание UA конкретными визуальными примерами.
