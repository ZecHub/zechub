...
[Ebe nrụọrụ weebụ](https://electriccoin.co) - [Github](https://github.com/Electric-Coin-Company) - [X/Twitter](https://x.com/ElectricCoinCo)
...
Usoro ohuru a nke ngwa oru ego, nke onye obula nwere ike inweta, ga-abụ enyi na enyi, nke onwe ya kpamkpam na nhọrọ maka ikpughe, na akụrụngwa nkwado ya ga-ekesa ma sie ike.
...
E wuru maka ịkwụ ụgwọ nkeonwe. Zashi bụ akpa ego ZEC echekwara onwe ya maka azụmahịa dijitalụ ezoro ezo.
...
Mmekọrịta:
- [Mkpụrụ ego:](https://electriccoin.co/blog/coinbase-zashi-1-2-release/) ndị ọhụrụ crypto nwere ike ịzụta ZEC ozugbo n'ime obere akpa ahụ na-agbada nsogbu nke ndebanye aha akaụntụ, KYC, na iwepụ mkpụrụ ego site na mgbanwe.
...
Ndị otu ahụ ebutewo ọganihu a ma ama n'ọtụtụ oge, nke mbụ bụ [ntọhapụ nke Zcash](https://electriccoin.co/blog/zcash-begins/) dị ka ụwa mbụ azụmahịa ojiji nke Zero-Ihe Ọmụma Àmà.

Ọtụtụ ndị ọzọ na-eso dị ka [Sapling netwọk nkwalite](https://electriccoin.co/blog/sapling-activation-complete/) allowing for lighter, shielded transactions with a time reduction of 90% for constructing transactions, and a memory reduction of over 97%, enabling for shielded transactions on a mobile device for the first time.

Ọganihu kachasị mkpa bụ nke kachasị ọhụrụ.](https://electriccoin.co/blog/nu5-activates-on-mainnet-eliminating-trusted-setup-and-launching-a-new-era-for-zcash/) of the halo2 trustless proving system in Network Upgrade 5 for Zcash. This eliminated the trusted setup and launched a new era for Zcash. Since 2022, this has been active on the Zcash Mainnet and allows users to leverage a more secure & easily upgradeable construction for their payment protocol. 
...
Enwere ike ịchọta ego, iji ego eme ihe, na ozi ndị ọzọ metụtara ya na Transparency Reports na [blog ha](https://electriccoin.co/blog/).
