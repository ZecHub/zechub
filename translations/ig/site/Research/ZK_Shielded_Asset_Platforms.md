...
** [Ụgbọ okporo ígwè](https://railgun.org/):** Dị ka nkwekọrịta mara mma nke 1, Railgun dị ka ihe nkwụnye ego nke onwe na akụrụngwa DeFi n'ihi ịdị adị ya na Ethereum, Polygon, Binance Smart Chain, na Arbitrum.
Melite obere akpa ego RAILGUN gị na-enweghị njide, kpuchie akara ngosi ERC-20 ọ bụla n'ime adreesị 0zk nke ị họọrọ, Ozugbo echedoro, akara ngosi, nguzozi, na azụmahịa na-ezoro ezo - [Whitepaper](https://docs.railgun.org/wiki) 
...
**[ShadeProtocol](https://shadeprotocol.io/)**: Shade Protocol bụ usoro nke abụọ nke ngwa DeFi jikọtara na-echekwa nzuzo nke e wuru na Nzuzo Nzuzo. Ngwa ndị a bụ isi bụ stablecoins, ọchịchị, nkekọ, nkwekọrịta derivatives, mkpuchi, synthetics, ịgbazinye ego, DEXs, na ndị ọzọ - [Whitepaper]
...
For example, consider an NFT listing on Solana; its public state (e.g., price) is visible to all, including the fact that it's up for sale. But offers and trades should remain private - **Asset Swap**: Yes - [Whitepaper](https://shield.lightprotocol.com/) - [Light ọta Logo](https://miro.medium.com/v2/resize:fit:1358/1*C4Pe23afCwS05seCeZWBLA.png)
***

**[Njikọ Nzuzo](https://conceal.network/wiki/doku.php)**: The Conceal Network was built to provide the ability for individuals to communicate and financially interact with each other in an anonymous and decentralized manner. With Conceal, transactions can't be linked between the sender and the recipient. Additionally, Conceal uses ring signatures and one-time addresses for truly anonymous payments - **Asset Swap**: Yes - [Whitepaper](https://conceal.network/wiki/doku.php) - [Conceal.png] Ọ bụrụ na ị na-eme ihe ọ bụla,](https://conceal.network/images/media/media_articles_01.png)
***
...
**[Dark.fi](https://dark.fi/)**: DarkFi is an anonymous L1 based on zero-knowledge, multi-party computation, and homomorphic encryption. Anonymous proof-of-stake ensures validators are hidden. DarkFi offers an anti-fragile environment to create and run anonymous apps - **Asset Swap**: Yes - [Whitepaper](https://darkrenaissance.github.io/darkfi/) - [Ọchịchịrị.png](https://miro.medium.com/v2/resize:fit:878/0*auQOzkLMfYdoXlRy)
***


**[Njikọ Nzuzo](https://scrt.network/)**: Secret Network is a layer 1 blockchain built using the Cosmos SDK and is part of the broader interconnected Cosmos universe (IBC). Secret Network is the first mainnet blockchain with privacy-preserving smart contracts, launched in 2020. This makes it possible to build apps that are decentralized and permissionless—yet private - **Asset Swap**: Yes - [Whitepaper](https://docs.scrt.network/) -
[Ihe nzuzo.png](https://images.contentstack.io/v3/assets/blt38dd155f8beb7337/blt67f1d3f934bfa9b9/6229b0ba429f83163fd8ffbb/Untitled_(4).png)
***



**[TomoChain](https://tomochain.com/ecosystem/)**: TOMO bụ oghere ọha na eze nke 1. Tomochain bụ usoro nzuzo mepụtara na TomoChain ma hazie ya iji mepụta azụmahịa dị nchebe na enweghị ike ịchọpụta -** Asset Swap**: Ee- [Whitepaper](https://tomochain.com/files/technical-whitepaper-1.0.pdf) - [TomoChain.png]](https://s1.coincarp.com/logo/1/tomochain.png?style=200)
***
