# Maya Decentralized Exchange (Maya)
...
## Gịnị bụ Maya Protocol?

Maya bụ onye... [mgbanwe decentralized](https://nym.com/blog/what-is-dex) (DEX) system that enables trading of cryptocurrencies across different blockchains. You can, for example, swap Bitcoin (BTC) on the Bitcoin blockchain with Ethereum (ETH) on the Ethereum blockchain in an easy way, without holding the assets or involving any centralized authorities or Know Your Customer (KYC) procedures.
...
N'ụzọ dị otú a, ndị ọrụ nwere ike izipu otu ụdị akara ngosi na blockchain ma nata ụdị ọzọ na ngọngọ nke ọzọ, niile n'asụsụ ala na-enweghị iji tokens.

## Gịnị Bụ Ihe Akaebe nke Njikọ?
...
## Ọdịiche dị n'etiti Maya na THORChain
...
### Nchedo site na Mfu Na-adịgide Adịgide

Usoro nke na-echebe ndị na enye ego mgbazinye site n'ọnwụ oge (LPs) ha nwere ike inwe mgbe ịnye ego mgbapụta, n'ihi mgbanwe dị icheiche a na-enwe kwa ụbọchị maka ọnụahịa akụ crypto.
ILP nwere 10% nke $ CACAO na-enye (10 nde $ CCAO) ma gbakwunye ya site na 10% nke ụgwọ protocol. ILP ga - arụ ọrụ ụbọchị 50 mgbe nkwụnye ego liquidity, yana mkpuchi kpuchie 100%.
...
### Ụzọ dị iche nke iji ihe ndị e debere edebe eme ihe
...
Ọzọkwa, ihe mgbaru ọsọ nke Maya bụ ịghọ * azụ-azụ maka ọrụ ndị ọzọ iji wuo ya, na olileanya ịhụ ọtụtụ ọhụụ ọhụrụ ma ọ bụ DEX arụpụtara n'elu akụrụngwa Maya.

## Njikọ nke obere akpa Maya protocol

Na-eme dị ka * ndabere, Maya kwesịrị ịkwado site na UI dị iche iche na obere akpa iji mee ihe. 
Nke a bụ ndepụta nke ụfọdụ ọrụ ndị na-akwado Maya:
...
DefiSpot: ọ bụghịzi n'ịntanetị, ngalaba ya anaghị edozi.
