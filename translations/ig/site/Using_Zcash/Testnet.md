...
Zcash upgrades its core protocol periodically (e.g., NU6.1, NU6.2 na Ironwood). Testnet activates new upgrades **before Mainnet**, allowing developers and the community to identify and fix bugs.
