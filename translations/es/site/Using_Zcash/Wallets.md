...
- Funciones: Libreta de direcciones | CrossPay | Near Intents | Pagos Flexa | Multifirma | Solicitud de pago | Memo blindado | Gastar antes de sincronizar | Dirección TEX | Compatibilidad con Tor | F-droid
- Ironwood: Listo
...
- Funciones: Extensión de navegador | Transacciones blindadas | Swaps cross-chain | Préstamos y empréstitos | Conexiones con DApp | Rhea
- Ironwood: Listo
...
- Compatibilidad de wallet: Frase semilla | Viewing Key | Unified Address | Clave privada | Spending Key | Copia de seguridad de wallet / Exportación de claves | Wallet de nodo completo
...
- Pools: Transparente | Sapling | Ironwood
- Funciones: Autocustodia | Clave privada almacenada localmente | No requiere KYC | Sin dependencia del servidor Zend para la actividad de wallet | Transacción blindada cifrada | Recuperación de semilla | Memo blindado | Autenticación con Passkey
...
- Compatibilidad de wallet: Frase semilla | Viewing Key | Unified Address | Spending Key | Wallet HD | Gestión de claves privadas
- Pools: Transparente | Sapling | Ironwood
- Funciones: Libreta de direcciones | Compatibilidad con Tor | Compatibilidad con I2P | Integración con Zebra/Zebrad | Historial de transacciones | Exportación de transacciones | Derivación local de testigos | Tarifa dinámica (ZIP-317) | Compatibilidad con NU6.2 | Compatibilidad con migración a NU6.3 | Memo blindado
- Ironwood: Listo
...
- Dispositivos: Escritorio
- Sistema operativo: Windows | Linux | macOS
- Compatibilidad de wallet: Frase semilla | Spending Key | Clave privada | Copia de seguridad de wallet / Exportación de claves
- Pools: Transparente | Sapling | Ironwood | Sprout
