...
Un glosario completo de términos clave, conceptos y recursos relacionados con Zcash.
...
| Término | Definición |
|------|-----------|
| Actions | En lugar de crear varias pruebas individuales para cada Spend y Output, el protocolo Orchard las fusiona en una sola Action. |
| Addresses | Zcash tiene direcciones Shielded (Z/zaddr) y Transparent (T/taddr). Las direcciones Unified (UA) están sustituyendo gradualmente a Z y T tras la actualización NU5. |
| Arborist Call | Una llamada quincenal que cubre actualizaciones sobre el desarrollo del protocolo y la investigación de Zcash. Se organiza en el Foro de la Comunidad de Zcash y en Discord. [Notas de la reunión](https://github.com/ZcashCommunityGrants/arboretum-notes) / [Anuncios del foro](https://forum.zcashcommunity.com) |
| Auto-shielding | Permite a los usuarios (más concretamente a sus wallets) mover automáticamente fondos desde una dirección transparente al pool más reciente de ZEC blindado. |
...
| Equihash | El algoritmo de minería de prueba de trabajo orientado a memoria que se utiliza en Zcash. |
| Events | El calendario de eventos relacionados con Zcash puede verse en [Luma](https://luma.com/zcash) y [Zcash Foundation](https://zfnd.org/zf-events/) |
| Exchanges | [Lista de exchanges que admiten Zcash](https://z.cash/exchanges/) |
...
| Término | Definición |
|------|-----------|
| Halo | Permite actualizaciones de circuitos sin necesidad de trusted setups, haciendo que el protocolo blindado de Zcash sea más ágil para futuras mejoras y extensiones. [Explicación técnica](https://z.cash/learn/what-is-halo-for-zcash/) |
| HD Wallet | Las wallets jerárquicas determinísticas generan una serie de pares de claves a partir de una sola semilla, proporcionando comodidad y facilidad de gestión, además de un alto nivel de seguridad. |
| Heartwood | La 4.ª gran actualización de red de Zcash. [Más información](https://z.cash/upgrade/heartwood/) |

## I

| Término | Definición |
|------|-----------|
| Index | El índice ZCX de CoinDesk representa un tipo de cambio spot en tiempo real equivalente al USD para Zcash. [Índice de precio](https://www.coindesk.com/indices/zcx/) |
...
| Término | Definición |
|------|-----------|
| JubJub | Una curva elíptica diseñada para implementarse eficientemente en circuitos zk-SNARK. |

## K

| Término | Definición |
|------|-----------|
| Keystone Wallet | Una hardware wallet con air-gap y soporte nativo para Zcash (Orchard blindado), compatible con ZODL para firma en frío. [Keystone](https://keyst.one) |
...
| Término | Definición |
|------|-----------|
| Recovery Phrase | Una secuencia de 12 o 24 letras y números usada para hacer una copia de seguridad y restaurar una wallet. En Zcash, esta frase regenera las spending keys y viewing keys, por lo que es crítica para la recuperación de fondos y la seguridad. |
...
| Sprout | La versión original del protocolo blindado de Zcash (lanzada en 2016). |
...
| Término | Definición |
|------|-----------|
| Unified Address | Formato moderno de dirección (introducido en NU5) que funciona tanto para pagos transparentes como blindados en una sola cadena. |
| Upgrade Activation | La altura de bloque específica en la que una actualización de red (p. ej., NU5, NU6) se activa automáticamente. |

## V

| Término | Definición |
|------|-----------|
| Viewing Key | Una clave privada que te permite ver el saldo y el historial de transacciones de una dirección blindada sin poder gastar los fondos. |

## W

| Término | Definición |
|------|-----------|
| Wallet | Software o hardware que almacena claves privadas y te permite enviar/recibir ZEC. Entre las wallets activas están ZODL (iOS/Android), Zingo! (móvil/escritorio), Nighthawk (Android), Zkool (móvil/escritorio), Zallet (próximamente) y Keystone (hardware). Para ver la lista completa, consulta [Wallets del ecosistema Zcash](https://z.cash/ecosystem/?wallets=#tag-wallets) |
...
| Término | Definición |
|------|-----------|
| XZC | Un símbolo ticker antiguo para Zcash usado en algunos exchanges heredados. El ticker oficial es ZEC. |
...
| Término | Definición |
|------|-----------|
| Zcash | Criptomoneda centrada en la privacidad que utiliza zk-SNARKs. Conecta pagos transparentes (al estilo de Bitcoin) y pagos totalmente blindados. |
| Zcash Foundation | Organización independiente sin ánimo de lucro que apoya el ecosistema de Zcash, financia el desarrollo y promueve la privacidad. |
| Zcash Network | Red peer-to-peer de nodos que valida transacciones y mantiene la blockchain. |
...
**¿Quieres contribuir?** [Edita esta página en GitHub](https://github.com/ZecHub/zechub/edit/main/site/Glossary_and_FAQs/Zcash_Library.md)
