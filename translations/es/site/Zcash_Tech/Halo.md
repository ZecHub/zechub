...
+ [Anoma, un protocolo multichain de intercambios atómicos que preserva la privacidad](https://anoma.net/blog/hash-functions-in-plonkup)

+ [Oribis, un zkRollup L2 en Cardano](https://docs.orbisprotocol.com/orbis/technology/halo-2)

+ [Darkfi, una blockchain privada zkEVM de L1](https://dark.fi/book/arch/arch.html)
