...
| Term | Definition |
|------|-----------|
| ECC | Electric Coin Company。以前は Zcash Company として知られていた、Zcash プロトコルを支えるチームです。 |
...
| NU7 | 今後予定されている Zcash の 8 回目の主要ネットワークアップグレードです。2026 年には ZODL を通じたコミュニティ感情調査が実施中です。さらなる Shielded pool の改善とガバナンス更新が含まれる見込みです。[フォーラムでの議論](https://forum.zcashcommunity.com/t/nu7-sentiment-polling-questions-for-community-review-coinholder-voting-via-zodl/55713) |
...
| Term | Definition |
|------|-----------|
| YWallet | Orchard、Sapling、Transparent アドレスをサポートする、高性能でプライバシー重視の Zcash ウォレットです。高速な同期速度で知られています。iOS と Android で利用可能です。[YWallet](https://ywallet.app) |
...
| Zallet | Zaino 上に構築される、Electric Coin Co / ZODL チームによる今後登場予定の公式 Zcash ウォレットです。2026 年時点で Zallet Alpha が活発に開発中です。[Forum](https://forum.zcashcommunity.com/t/zcash-z3-updates-formerly-zcashd-deprecation/48965) |
...
| ZODL | Electric Coin Company のコンシューマー向け製品群の新ブランド名で、ZODL ウォレットアプリ（旧 ECC Wallet）や、Coinholder 投票のための ZODL ガバナンスプラットフォームを含みます。[zodl.com](https://zodl.com) |
