...
```
エラーが発生した場合は、[ここ](https://www.digitalocean.com/community/tutorials/how-to-install-node-js-on-ubuntu-22-04)に代替のNodeJSインストール方法があります。
...
* AppImageを使用するか、解凍フォルダ内のバイナリを使用できます。
* お楽しみください! :)
