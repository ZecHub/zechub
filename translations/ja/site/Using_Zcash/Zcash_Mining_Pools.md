...
Zcashマイニングプールは、個々のマイナーがコンピューティングパワー（ハッシュレート）を組み合わせて利用できるサービスです。リソースを共有することで、参加者はネットワークブロックを解決する確率を高め、ソロマイニングに依存する予測不能な宝くじシステムではなく、一貫した小さな報酬を得ることができます。
...
- 個人払い: Bitcoin (BTC)で支払われる
- プールタイプ: ハッシュレートマーケットプレイス / プロキシプール
- プール手数料: 0,5% - 1%
