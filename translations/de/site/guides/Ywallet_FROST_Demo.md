...
> **Ywallet wird nicht mehr gepflegt.** Der Entwickler hat bestätigt, dass es für Ironwood (NU6.3) nicht aktualisiert wird und daher der Chain nicht mehr folgen kann; die folgenden Schritte können auf dem Mainnet nicht durchgeführt werden. Diese Seite wird als Referenz beibehalten. Zkool, vom selben Entwickler, ist der gepflegte Nachfolger und unterstützt FROST-Multisig.
...
## Jeden Participant diese Transaktion signieren lassen
