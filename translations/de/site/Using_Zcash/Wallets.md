...
- Funktionen: Adressbuch | CrossPay | Near Intents | Flexa-Zahlungen | MultiSignature | Zahlungsanfrage | Shielded Memo | Ausgeben vor der Synchronisierung | TEX-Adresse | Tor-Unterstützung | F-droid
- Ironwood: Bereit
...
- Wallet-Unterstützung: Seed Phrase | Viewing Key | Unified Address | Hardware
- Pools: Transparent | Sapling | Ironwood
- Funktionen: Adressbuch | Cold Storage | Diversifizierte Adresse | Zahlungsanfrage | Pool-Transfer | Shielded Memo | TEX-Adresse | Abstimmung | WarpSync
...
- Wallet-Unterstützung: Seed Phrase | Viewing Key | Unified Address
- Pools: Transparent | Sapling | Ironwood
- Funktionen: Adressbuch | Adressprüfung | Automatisches Shielding | Diversifizierte Adresse | Zahlungsanfrage | Shielded Memo | TEX-Adresse | Testnet-Unterstützung
...
- Pools: Transparent | Sapling | Ironwood
- Funktionen: Adressbuch | Grafische Oberfläche | Shielded Memo | Testnet-Unterstützung
...
- Wallet-Unterstützung: Seed Phrase | Viewing Key | Unified Address | Privater Schlüssel | Spending Key | Wallet-Backup / Schlüssel-Export | Vollständige-Knoten-Wallet
...
- Pools: Transparent | Sapling | Ironwood
- Funktionen: Selbstverwahrung | Privater Schlüssel lokal gespeichert | Kein KYC erforderlich | Keine Abhängigkeit von Zend-Servern für Wallet-Aktivitäten | Verschlüsselte Shielded-Transaktion | Seed-Wiederherstellung | Shielded Memo | Passkey-Authentifizierung
...
- Geräte: Desktop
- Betriebssystem: Windows | Linux | macOS
- Wallet-Unterstützung: Seed Phrase | Spending Key | Privater Schlüssel | Wallet-Backup / Schlüssel-Export
- Pools: Transparent | Sapling | Ironwood | Sprout
