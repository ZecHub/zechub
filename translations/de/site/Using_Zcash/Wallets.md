...
- Wallet-Unterstützung: Seed Phrase | Viewing Key | Unified Address
- Pools: Transparent | Sapling | Ironwood
- Funktionen: Adressbuch | Finanzübersicht | Zahlungsanforderung | PepperSync | Shielded Memo | Testnet-Unterstützung
- Ironwood: Bereit
...
- Wallet-Unterstützung: Seed Phrase | Viewing Key | Unified Address
- Pools: Transparent | Sapling | Ironwood
- Funktionen: Adressbuch | Adressprüfung | Automatisches Shielding | Diversifizierte Adresse | Zahlungsanforderung | Shielded Memo | TEX-Adresse | Testnet-Unterstützung
...
- Wallet-Unterstützung: Seed Phrase | Viewing Key | Unified Address | Hardware
- Pools: Transparent | Sapling | Ironwood
- Funktionen: Adressrotation | Breite Schlüsselunterstützung | Verschlüsselte Exporte | FROST-Multisig | Synchronisierung mehrerer Konten | Shielded Memo | Testnet-Unterstützung
- Ironwood: Bereit
...
- Funktionen: Browser-Erweiterung | Shielded-Transaktionen | Cross-Chain-Swaps | Kreditvergabe & Kreditaufnahme | DApp-Verbindungen | Rhea
- Ironwood: Bereit
...
- Wallet-Unterstützung: Seed Phrase | Viewing Key | Unified Address | Privater Schlüssel | Spending Key | Wallet-Backup / Schlüsselexport | Wallet mit vollständigem Knoten
...
- Wallet-Unterstützung: Seed Phrase | Passkey | Unified Address | Privater Schlüssel | Selbstverwahrende Wallet
- Pools: Transparent | Sapling | Ironwood
...
- Pools: Transparent | Sapling | Ironwood
- Funktionen: Adressbuch | Tor-Unterstützung | I2P-Unterstützung | Zebra/Zebrad-Integration | Transaktionsverlauf | Transaktionsexport | Lokale Witness-Ableitung | Dynamische Gebühr (ZIP-317) | NU6.2-Kompatibilität | Unterstützung der NU6.3-Migration | Shielded Memo
- Ironwood: Bereit
...
- Wallet-Unterstützung: Seed Phrase | Viewing Key | Unified Address | Wallet für mehrere Konten | Selbstverwahrende Wallet | Verwaltung privater Schlüssel | Agent-Wallet-Unterstützung
- Pools: Transparent | Sapling | Ironwood
- Funktionen: NEAR Intents | Zahlungsanforderungen | Shielded Memo | Shielded-Transaktion als Standard | Testnet | Cross-Chain-Swap | CipherPay | Viewing Key | KI-Agent | MCP-Server | CLI-Wallet | FROST | Beta
- Ironwood: In Arbeit
...
- Geräte: Desktop
- Betriebssystem: Windows | Linux | macOS
- Wallet-Unterstützung: Seed Phrase | Spending Key | Privater Schlüssel | Wallet-Backup / Schlüsselexport
- Pools: Transparent | Sapling | Ironwood | Sprout
