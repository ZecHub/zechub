...
## Was sind Zcash-Mining-Pools?

Zcash-Mining-Pools sind Dienste, die es einzelnen Minern ermöglichen, ihre Rechenleistung (Hashrate) zu bündeln. Durch das Zusammenlegen von Ressourcen erhöhen die Teilnehmer ihre Chancen, Knoten-Blöcke zu lösen, und erhalten regelmäßige, kleinere Auszahlungen, anstatt sich auf das unvorhersehbare Lotteriesystem des Solo-Minings zu verlassen.

---

## Liste der Zcash-Mining-Pools:
...
- Webseite: [Nanopool](https://zec.nanopool.org/)
- Private Auszahlungen: Nein
- Pool-Typ: Pay Per Last N 
- Pool-Gebühr: 1%
...
- Private Auszahlungen: Auszahlung in Bitcoin (BTC)
- Pool-Typ: Hashrate-Marktplatz / Proxy-Pool
- Pool-Gebühr: 0,5% - 1%
...
- Private Auszahlungen: JA
- Pool-Typ: Pay Per Last N Shares (PPLNS)
- Pool-Gebühr: 1%
