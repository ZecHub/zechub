...
- [Eine Schwachstelle in zcash/zcash melden](https://github.com/zcash/zcash/security/policy)
- [Eine Schwachstelle an ZF melden](https://github.com/ZcashFoundation/zebra/security/policy)
