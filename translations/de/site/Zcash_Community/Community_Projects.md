...
Entdecke Tools, Wallets, Anwendungen, Bibliotheken und Ökosystem-Initiativen, die von der Zcash-Community und dem breiteren Zero-Knowledge-Ökosystem entwickelt wurden.
...
### My First Zcash
Lehrreiches Arbeitsbuch, erstellt von der globalen Zcash-Community.  
...
### ZShieldHer
Zcash-Bildungsseite für Überlebende häuslicher Gewalt.  
[Besuchen](https://zshieldher.com/)

### ZecForge
Creator-Schmiede für das Zcash-Ökosystem mit Fokus auf Onboarding, Creator-Entwicklung und Content-Verteilung.  
...
Datenschutzorientiertes audiovisuelles Kollektiv, das für Veranstaltungen der Open-Source- und dezentralen Tech-Community schult, gemeinsam kreiert und ehrenamtliche AV-Unterstützung bereitstellt.  
...
### ZGo
Zcash-Kasse, die es Verkäufern und Händlern ermöglicht, Zcash-Zahlungen anzunehmen.  
[Besuchen](https://zgo.cash)

### Zimppy
Machine Payment Protocol (MPP) für Zcash. Entwickelt für KI-Agenten und automatisierte Machine-to-Machine-Workflows. Unterstützt vollständig abgeschirmte Orchard-Zahlungen.  
...
### ZODL
Flaggschiff-Zcash-Wallet von ZODL (ehemals Zashi). Verfügbar für iOS und Android. Unterstützt abgeschirmte ZEC und NU7-Coinholder-Abstimmungen.  
...
### ZecVault
Zielbasierte Spar-Wallet, aufgebaut auf abgeschirmten Zcash-Transaktionen.  
...
### Gem Wallet
Multichain-, Open-Source-, Self-Custodial-Wallet, die das Senden, Empfangen und Tauschen von ZEC unterstützt.  
[Besuchen](https://gemwallet.com/)

### TIPZ
Live-Non-Custodial-Tipping-Plattform, bei der jedes Trinkgeld als abgeschirmte ZEC ankommt. Unterstützt Cross-Chain-On-Ramps über NEAR Intents.  
...
### CipherScan
Datenschutzorientierter Zcash-Blockchain-Explorer. Gebaut mit Next.js 15, TypeScript und Rust/WASM. Abfragen geben keine Metadaten über die Anfrage preis.  
...
### OpenZcash
Öffentliches Transparenz-Dashboard für den Zcash Dev Fund, einschließlich ZCG- und FPF-Grant-Abrechnung, der Lockbox, Governance und Auszahlungen.  
...
### Zcash.Space
Browserbasierter Zcash Unified Address-Parser zur Analyse von Unified Addresses.  
[Besuchen](https://zcash.space/)

### ZecMap
Weltkarte von Unternehmen und Orten, die Zcash akzeptieren.  
...
### Zlink
Verzeichnis zum Finden von Links, Tools und Informationen über das Zcash-Ökosystem.  
...
### ZcashNames
Menschenlesbare Namen für abgeschirmte Zcash-Adressen (z. B. `alice.zec` wird zu einer Unified Address aufgelöst).  
...
### Zentat
Browser-Erweiterung, die Fiat-Währungspreise beim Surfen im Web in Echtzeit in ZEC umrechnet.  
[Besuchen](https://chromewebstore.google.com/detail/zentat/lpndbahladndclecodadoljlplfaldac)

### Shielded Wall
Anonyme Beichtplattform, die von der Privatsphäre von Zcash angetrieben wird.  
...
## Breitere Anwendungen mit Zcash
...
### Shielded Labs
Unabhängige, spendenfinanzierte Unterstützungsorganisation für Zcash mit Sitz in der Schweiz. Die erste Organisation im Ökosystem, die niemals Mittel aus dem Development Fund oder aus Blockbelohnungen erhalten hat.  
[Besuchen](https://shieldedlabs.net/)

### Cypherpunk
Unternehmen mit Fokus auf Privatsphäre, Selbstsouveränität und Cypherpunk-Werte. Baut Tools für Menschen, die ihr digitales Leben schützen müssen.  
