...
- Verwende abgeschirmte Adressen, um gemeinsame Mittel aufzubewahren
- Begrenze die Sichtbarkeit von Guthaben und Transaktionen
- Trenne operative Rollen von der öffentlichen Identität
- Nutze Memos für interne Rechenschaft
...
- Ausgabenverlauf
- Identitäten der Mitwirkenden

Dadurch entstehen Risiken:
- Zielgerichtete Angriffe auf die Mittel
- Interne Konflikte durch Transparenzdruck
- Verlust strategischer Privatsphäre
...
- Transaktionen auszuführen, ohne Details offenzulegen
- Interne Rechenschaft sicherzustellen, ohne öffentliche Offenlegung
...
- Optional: gemeinsame Dokumentation zur Nachverfolgung
...
- Erzeuge eine **z-address** für die Treasury
- Diese wird zum Hauptkonto für die Verwahrung


### Schritt 2: Rollen definieren

Trenne die Verantwortlichkeiten:
- Treasury-Verantwortliche:r (kontrolliert die Mittel)
- Mitwirkende (beantragen Ausgaben)
- Prüfer:innen (genehmigen intern)

Vermeide es, diese Rollen mit öffentlichen Identitäten zu verknüpfen.



### Schritt 3: Mittel privat empfangen

- Nimm Beiträge über die abgeschirmte Adresse an
- Ermutige Mitwirkende, aus abgeschirmten Wallets zu senden



### Schritt 4: Transaktionen intern nachverfolgen

Verwende:
- Wallet-Memos
- Off-Chain-Protokolle (z. B. gemeinsame Dokumente)
...
### Schritt 5: Zahlungen privat ausführen

- Sende Mittel über abgeschirmte Transaktionen (z → z)
- Vermeide es, Empfängeridentitäten öffentlich offenzulegen
...
- Transaktionen nicht intern nachverfolgen  
- Die Treasury-Adresse mit identifizierbaren Personen verknüpfen  
...
- Mitwirkende und Empfänger schützen
- Arbeiten, ohne die Finanzstrategie offenzulegen
...
Du verstehst, wie du gemeinsame Mittel privat verwalten kannst.
