...
- Sende immer von einer **shielded address**
- Vermeide direkte t-zu-t-Transaktionen
- Trenne die Verknüpfbarkeit zwischen Identitäten
- Achte auf Timing und Muster
...
- Für Menschen, die einem Überwachungsrisiko ausgesetzt sind
...
Dadurch entsteht ein **nachverfolgbarer Finanzgraph**.
...
Dadurch werden folgende Verknüpfungen aufgebrochen:
- Verknüpfbarkeit von Adressen
- Öffentliche Nachverfolgung von Transaktionen
...
Wenn sich deine Mittel in einer transparenten Adresse befinden:
- Verschiebe sie zuerst in eine shielded address


### Schritt 2: Sende von Shielded zu Shielded
Bevorzuge immer eine `z to z`-Transaktion

Das gewährleistet maximale Privatsphäre.


### Schritt 3: Vermeide die Verknüpfung mit deiner Identität

TU das NICHT:
- Transaktionen öffentlich ankündigen
- Dieselbe Adresse in verschiedenen Kontexten wiederverwenden
- Adressen mit bekannten Identitäten verknüpfen

### Schritt 4: Berücksichtige zeitliche Muster

Fortgeschrittener Tipp:
- Vermeide es, direkt nach dem Erhalt großer Beträge zu senden
- Durchbrich vorhersehbare Muster, wo immer möglich
...
- Transaktionen öffentlich bestätigen  
- Metadaten ignorieren (Zeitpunkt, Häufigkeit)
...
- Vermeiden, deine Identität zu verknüpfen
- Die Nachverfolgbarkeit reduzieren
...
Du kannst jetzt Mittel privat senden, ohne deine Identität offenzulegen.
