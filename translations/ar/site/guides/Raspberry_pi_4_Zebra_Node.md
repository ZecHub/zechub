...
إذا واجهت أي مشكلات أثناء بناء Zebra أو تشغيله، فراجع [وثائق Zebra](https://zebra.zfnd.org/user/troubleshooting.html) للحصول على نصائح استكشاف الأخطاء وإصلاحها ومعلومات إضافية.
