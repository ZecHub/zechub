...
Nneɛma a ɛsɛ sɛ wode si Zcash so, a wɔahyehyɛ no akuwakuw sɛnea emu biara yɛ ma sen sɛ wɔbɛkyerɛw no akuwakuw biako mu.
...
| Crate | Nea ɛyɛ ma |
|:--|:--|
| zcash_client_akyigyinafo | "APIs a wɔde yɛ Zcash hann afɛfo a wɔabɔ wɔn ho ban", a sync ne nkitahodi adansi ka ho |
...
[ZIP ahorow a wɔde yɛ adwuma](https://zips.z.cash) yɛ baabi a wɔahyɛ nsakrae ho nyansa na wɔakyerɛ, na index no kyerɛ nea ɛyɛ nsɛm a wɔayɛ ne nea etwa to. Consensus nsakrae hyɛn wɔ network upgrades, na ZecHub di wɔn a wɔwɔ [Network Nkɔsoɔ a Wɔayɛ](/start-here/network-upgrades) kratafa.
...
Sɛ wowɔ resource bi a wode bɛka ho, anaasɛ wuhu biribi wɔ ha a ayɛ stale a, bue issue anaa pull request. Ɛnyɛ bere nyinaa na akuw ahorow wɔ tumi a wɔde bɛma biribiara ayɛ nea ɛwɔ hɔ mprempren, na nea wutuu mmirika kɔɔ mu no frankaa a wode bɛhyɛ mu no boa ma wɔkyerɛ akwankyerɛfo no kwan.
