...
# Hena na Obetumi Ahu Wo Zcash Katua?

## TL;DR

- Zcash ma wo **address ahorow abien**: transparent (`t`) na wɔabɔ ho ban ( .`z` or `u`).
...
## Ade biako a ɛsɛ sɛ yedi kan te ase

Wɔ blockchains dodow no ara so no, ɔkwan biara nni hɔ a wobɛfa so ayɛ. Biribiara a wode bɛmena no yɛ baguam, daa, ma obiara a ɔhwɛ.

Zcash ma wo kwan a wobɛpaw mmom. Wɔyɛ saa paw no mprenu: **pɛnkoro bere a wopaw address a wode bɛkɔ, ne pɛnkoro bere a woasi nea obenya safe a ɔde bɛkenkan w’abakɔsɛm no ho gyinae.**
...
## Paw nea edi kan: address bɛn

Zcash sikatua biara kɔ address abien ntam, na emu biara betumi ayɛ nea ɛda adi pefee anaasɛ wɔabɔ ho ban. Ɛno ma wonya akwan anan, na ɛsono dodow a emu biara pue.

Nhwɛsoɔ no yɛ mmerɛ sene sɛdeɛ ɛteɛ: **biribiara a ɛka address a ɛda adi pefee no bɛyɛ baguam.** Katua a ɛtena ɔtare a wɔabɔ ho ban no mu kwan no nyinaa nkyerɛ hwee sɛ ɛka a wɔbɔ.

Eyi ho hia kɛse bere a wotwe wo ho fi nsakrae bi mu no. Nneɛma pii a wɔde sesa nneɛma no de kɔ address ahorow a ɛda adi pefee nkutoo so, enti nea wɔtwe fi mu no yɛ baguam. W’ankasa bɔ sika no ho ban bere a aba pɛ, ansa na woasɛe no.

Sɛ wopɛ sɛ wuhu nea ɔhwehwɛfo kenkan no pɛpɛɛpɛ a, hwɛ [Nea block explorer betumi ahu](/zcash-tech/what-a-block-explorer-can-see).

---

## Paw a ɛto so abien: hena na onya safe

Kokoamsɛm a wuntumi mma so da no ho nni mfaso. Ɛtɔ mmere bi a, ɛsɛ sɛ wokyerɛ sɛ biribi yɛ nokware kyerɛ akontaabufo, akontaabufo, anaa towtua adwumayɛbea bi. Zcash di eyi ho dwuma a ɛnsrɛ wo sɛ gyae tumidi.
...
## Ɔfã a wɔn a wɔrefi ase no hwere
...
- [Zcash foforo a wɔde di dwuma akwankyerɛ](/start-here/new-user-guide)
- [Nea block explorer betumi ahu](/zcash-tech/what-a-block-explorer-can-see)
- [Nsafe a wɔhwɛ](/zcash-tech/viewing-keys)
- [Nkitahodi ahorow](/using-zcash/transactions)
