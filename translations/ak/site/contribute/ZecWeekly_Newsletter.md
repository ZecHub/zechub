...
Hyɛ anan mu `YOUR-USERNAME` ne w’ankasa GitHub dwumadie din. URL a ɛwɔ atifi hɔ no yɛ beaeɛ na ɛrensiesie sɛdeɛ wɔakyerɛw no.
...
- Fa fael din format a nsɛmma nhoma no bisae anaasɛ nnansa yi nkyerɛase ahorow a wɔagye atom de adi dwuma no hyia.
- Fa ɔfa nhyehyɛe koro no ara sie sɛnea nsusuwso no te gye sɛ adwuma no bisa sɛ wɔmfa ɔkwan foforo so mma.
- Fa link ahorow a efi dapɛn a ɛfa ho no nkutoo mu ka ho.
- Kyerɛw nkyerɛkyerɛmu tiawa a emu da hɔ ma link biara sɛnea ɛbɛyɛ a akenkanfo bɛte nea enti a ɛho hia no ase.
- Kyerɛkyerɛ nsɛm a ɛnyɛ Borɔfo kasa ase anaa bɔ mua wɔ Borɔfo kasa mu bere a ɛho hia.
- Hwɛ link biara ansa na woabue pull request no.

### 4. Boaboa link ahorow ano wɔ bere a ɛfata mu

ZecWeekly taa ka Zcash abɔdeɛ a nkwa wom dwumadiɛ ho asɛm ma dapɛn a ɛwɔ hɔ mprempren no na wɔtintim no bɛyɛ dapɛn no awieeɛ. Bere a ahobammɔ wom sen biara ne:
...
### 5. Bue twetwe adesrɛ no

Sɛ wo nsɛmma nhoma fael no ayɛ krado a:

1. Fa wo nsakrae no hyɛ wo fork no so.
2. Bue twe adesrɛ bi kɔ mu `ZecHub/zechub` wɔ no so `main` fa.
3. Fa asɛmti a ɛne nea wɔatintim no hyia, te sɛ `Zcash Ecosystem Digest | May 30th`.
4. Fa asɛm no bata twe abisade nipadua no mu sɛnea ɛbɛyɛ a nhwehwɛmufo betumi de adwuma no abata adwuma no ho.

Nhwɛso twe adesrɛ nipadua:
...
- Wobue twe abisadeɛ ansa na wɔasi edition da anaa adwuma no so dua.
- Adwuma a wɔyɛ wɔ asɛm bi a ɛwɔ linked pull request dedaw ho.
- Twe adesrɛ no a wode bɛkɔ w’ankasa fork so sen sɛ wode bɛkɔ `ZecHub/zechub`.
- Fael din a ɛnteɛ a wode bedi dwuma anaasɛ wode fael no bɛto akyi `newsletter` folda no mu.
...
Ansa na wobɛsrɛ sɛ wobɛsan ahwɛ mu no, si so dua sɛ:
