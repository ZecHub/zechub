...
1. Bue [ZecHub akorae no](https://github.com/ZecHub/zechub).
...
4. Hwɛ sɛ wo twe abisade no bɛto w’ani so `ZecHub/zechub` sɛ base akoraeɛ ne `main` sɛ nkorabata a ɛwɔ nnyinaso no.
...
Fa [nsɛm krataa nsusuwso no di dwuma](https://github.com/ZecHub/zechub/blob/main/newsletter/newslettertemplate.md) sɛ wo mfiase. Nsɛmma nhoma ahorow a wɔatintim no ka [ .`newsletter`](https://github.com/ZecHub/zechub/tree/main/newsletter) folda no mu.
...
- Mfa dapɛn a ɛbɛba daakye amanneɛbɔ krataa nkɔma ansa na adwuma a wɔde bɛyɛ saa da no aba hɔ anaasɛ ansa na ZecHub asi so dua sɛ ɛsɛ sɛ wusiesie.

Sɛ nsɛmma nhoma bi ka sɛ ɛsɛ sɛ wode mena ansa na da pɔtee bi adu a, di saa da no akyi. Sɛ akasakasa bi da krataafa yi ne asɛm bi a ɛwɔ hɔ mprempren ntam a, di mprempren asɛm no akyi.
...
[ZecNnawɔtwe Biara Nneɛma a Wɔakora So](https://zechub.substack.com/p/archive)
