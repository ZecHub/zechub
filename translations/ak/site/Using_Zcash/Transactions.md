...
Zcash asɛm bi nyɛ nea etwa to esiane sɛ epue wɔ wo sika kotoku mu nti. Ɛbɛyɛ nea etwa to ma dwumadie a wɔtaa de di dwuma bere a wɔatu no akɔ block mu na wɔanya adanseɛ a ɛdɔɔso ama wo tebea no. Ebia nsakrae ne nnwuma bɛhwehwɛ sɛ wosi so dua pii sen sɛnea sika kotoku bi kyerɛ wɔ default so.
...
6. **So sika kotoku no rebisa wo sɛ fa resend?**
   - Di sika kotoku no akwankyerɛ a ɛwɔ hɔ mprempren no akyi bere a woahwɛ sɛ asɛm a atwam no atwam, adi nkogu, anaasɛ enni mu bio nkutoo.
...
- **Expired** kyerɛ sɛ asɛm no bere awiei sorokɔ atwam. Wɔ ZIP 203 ase no, wɔrentumi ntu asɛm a ne bere atwam no sorokɔ wɔ saa sorokɔ no akyi.
- **Dropped** kyerɛ sɛ node biako anaa nea ɛboro saa nkora asɛm no so bio wɔ wɔn mempool mu. Eyi betumi aba esiane bere a ɛtwam, ɛka a ɛba fam, mempool nhyehyɛe, restart suban, anaa relay nsonsonoe nti.
