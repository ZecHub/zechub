...
| Ahofama Nhyehyɛe | Ma kwan ma committer bi de ne ho to polynomial a ɛwɔ ahama tiawa bi a verifier betumi de adi dwuma de asi so dua sɛ wɔakyerɛ sɛ wɔayɛ nhwehwɛmu wɔ committed polynomial no ho. Mfaso wɔ so ma nkitahodi ho ka a wɔtew so wɔ Zcash protocol no mu. |
| Mpɔtam hɔ | [Ɔmanfoɔ Zcash Mpɔtam Nhyiamu](https://forum.zcashcommunity.com) / [Zcash Mpɔtam Hɔ Akasakasa](https://discord.com/channels/669694001464737815/669694001921654794) / [Zcash R&D Nkitahodi](https://discord.com/invite/6AK7keWFaK) / [Reddit a wɔde di dwuma](https://www.reddit.com/r/zec/) / [Telegram a wɔde kyerɛw nsɛm](https://t.me/Zcash_Community) / [Twitter so](https://x.com/zcash) |
...
| Asɛmfua | Nkyerɛaseɛ |
|------|-----------|
| Aban a Wɔde Di Dwuma | Wɔkyerɛw gyinaesi ahorow a efi ZIP nhyehyɛe no mu no wɔ Zcash nkyerɛkyerɛmu no mu, ne softwea a ɛde ntwamutam no di dwuma no nso. Wɔgye nsakraeɛ no tom wɔ nkɔnsɔnkɔnsɔn so berɛ a ntwamutam no mu dodoɔ no ara gye nkɔsoɔ no tom na ɛnsɛe adwene a ɛwɔ mu no. [Protocol Abakɔsɛm a Edi Mu](https://zfnd.org/protocol-governance/) |
...
| Nneɛma a wɔde ka bom | Wubetumi agye Zcash sikatua denam 3rd party providers dodow bi so. [Wɔn a Wɔyɛ Katua Ho Nsiesiei](https://z.cash/zcash-for-business/) |
| Nkitahodi Adanse Nhyehyɛe | Afiri a ɛnyɛ adwene a ɛyɛ akontabuo ho nhwɛsoɔ sɛ nkrasɛm a wɔsesa wɔ nnipa mmienu ntam: Ɔsɔfoɔ ne Ɔhwɛfoɔ. |
| Sika a Wɔde To gua | Sikasɛm mu akwan dodow bi wɔ hɔ ma ahyehyɛde ahorow a wɔde wɔn sika hyɛ mu anaa abusua adwumayɛbea ahorow a wɔpɛ sɛ wonya Zcash ho nimdeɛ. [Nsɛm a wɔahyehyɛ no nyinaa](https://z.cash/investors/) |
| Dade Nnua | Netwɛk upgrade (NU6.3) a ɛyɛɛ adwuma wɔ mainnet so wɔ 28 July 2026 wɔ block 3,428,143. Ɛde ɔtare foforo a wɔabɔ ho ban bae, a wɔsan frɛ no Ironwood, na ɛmaa Orchard ɔtare no yɛɛ nea wɔsɛe no nkutoo ma enti bo a ɛwɔ hɔ dedaw no tu fa turnstile no so. [Nsɛm pii](/zcash-tech/ironwood) |
...
| Asɛmfua | Nkyerɛaseɛ |
|------|-----------|
| Keystone Sikakorabea | Hardware sika kotoku a mframa wom a ɛwɔ native Zcash (Orchard shielded) mmoa, a ɛne ZODL hyia ma awɔw mu nsaano nkyerɛwee. [Keystone a wɔde yɛ nneɛma](https://keyst.one) |
...
| Metadata a ɛwɔ hɔ | Data a wɔyɛ no ka obi a ɔde di dwuma no Zcash asɛm no ho. Eyi betumi ayɛ block height, transaction version anaa expiry height ne nea ɛkeka ho |
| Mobile SDK a wɔde di dwuma | SDK a emu yɛ hare a ɛka Android ne Zcash bom, ɛma Android app ahorow a ɛto so abiɛsa tumi de nnwuma a wɔabɔ ho ban mena na wogye. [Github a wɔde di dwuma](https://github.com/zcash/zcash-android-wallet-sdk) |
...
| Nneɛma pii a wɔde nsa hyɛ ase | Address a ɛhwehwɛ sɛ wɔde private key signatures pii di dwuma na ama wɔatumi asɛe sika. Mprempren, multisig dwumadie no, address a ɛda adi nko ara na ɛboa. |
...
| Asɛmfua | Nkyerɛaseɛ |
|------|-----------|
| Oblivious Nsɛm a Wɔde Di Dwuma | Ɔkwan bi a wɔreyɛ wɔ Project Tachyon mu a ɛma sika kotoku bi bisa data a ehia fi server a wontumi mfa wɔn ho nto so a ɛnkyerɛ nsɛm a wɔakyerɛw a ɛrebisa ho asɛm. Server no nsua wo nullifiers no da, ɛfiri sɛ protocol no ma wɔdannan wɔ ɔkwan a ɛntumi nkɔ so. [Kyerɛwto-kɔ-so](https://seanbowe.com/blog/tachyon-scaling-zcash-oblivious-synchronization/) |
...
| Awɔw bere mu | 1st Network Upgrade a ɛwɔ hɔ ma Zcash. [Nsɛm pii](https://zcash.readthedocs.io/en/latest/rtd_pages/nu_dev_guide.html#overwinter) |

## P

| Asɛmfua | Nkyerɛaseɛ |
|------|-----------|
| Katua a wotua | Ɛyɛ yie sɛ wode Zcash bedi dwuma ama da biara da adetɔ denam sikatua adwumayɛfoɔ dodoɔ bi so. [Apps a Wɔde Tua Ka](https://z.cash/pay-with-zcash/) |
...
| Asɛmfua | Nkyerɛaseɛ |
|------|-----------|
| QR Kood | Kood a mfiri tumi kenkan a wɔde kyerɛw Zcash address ahorow ma ɛyɛ mmerɛw sɛ wobɛhwehwɛ. Wɔtaa fa QR code ahorow a ɛwɔ nnɛyi Zcash sika kotoku mu so na ɛkyɛ Unified Addresses (UAs). |
| Quantum a Wɔsan Yɛ no | Agyapade bi a Ironwood hyɛ no nsow, a wɔakyerɛ wɔ [ZIP 2005 na ɔkyerɛwee](https://zips.z.cash/zip-2005), a ɛma wotumi san nya sika bi a ɛwɔ nkɔnsɔnkɔnsɔn mu no sɛ daakye quantum kɔmputa bi bubu cryptography a ɛbɔ ho ban nnɛ no a. Ɛyɛ ɔkwan a wɔfa so san nya ahoɔden mmom sen quantum resistance, na ɛfa Ironwood nsɛm a wɔakyerɛw ho, ɛnyɛ Sprout, Sapling anaa Orchard sika a ɛwɔ hɔ dedaw no ho. |
...
| Aguadi a Wɔabɔ ho ban | Aguadi a ɛda address ahorow a wɔabɔ ho ban nkutoo ntam. Kokoam koraa wɔ blockchain no so. |
| Sol/s | Ano aduru wɔ sekan biara mu - susu Equihash mining adwumayɛ. |
| Sika a Wɔsɛe no Safoa | Kokoam safoa a ɛma kwan ma wosɛe sika fi address a wɔabɔ ho ban so (ɛma wutumi nso hwɛ kari pɛ ne abakɔsɛm). |
...
| Nkitahodi | Akatua bi a ɛda wɔn a wɔde di dwuma ntam, a wɔde kɔ network no so na awiei koraa no wɔasi so dua wɔ block mu. |
| Aguadi no Bere Awiei | Nnwuma no twam wɔ bɛyɛ simma 25 akyi (20 blocks) sɛ wɔansi so dua a; sika no san ba ara kwa. |
| Nkitahodi ho Ka | Default fee yɛ 0.0001 ZEC. Nneɛma a wɔbɔ a ɛkɔ soro no nya nea edi kan; sika a ɛba fam koraa betumi ama wɔakyɛ anaasɛ bere atwa mu. |
| Address a ɛda adi pefee | Wɔsan frɛ no taddr. Efi ase wɔ t. Ɔmanfoɔ koraa (te sɛ Bitcoin). |
| Nkitahodi a ɛda adi pefee | Aguadi a ɛda address ahorow a ɛda adi pefee ntam nkutoo - biribiara da adi wɔ baguam. |
| Turnstile a wɔde dannan nneɛma | Akontaabu mmara a ɛhwɛ boɔ dodoɔ a ɛkɔ mu na ɛfiri ɔtare biara a wɔabɔ ho ban mu, enti ɔtare biara ntumi nyi nea ɛboro nea ɛkɔ mu. Wɔde di dwuma wɔ pool nsakrae biara mu wɔ Zcash abakɔsɛm mu, na mprempren wɔrewɛn atutra a efi Orchard kɔ Ironwood no. [Nsɛm pii](/zcash-tech/the-turnstile) |
