...
- [Zebra Book](https://zebra.zfnd.org)  Official Zebra documentation (Nkrataa ahodoɔ a etwa sɛ yɛhyehyɛ wɔ kasa no mu)
- [Zallet Nhoma no](https://zcash.github.io/zallet/)  Zallet krataa a w'atwerԑ no mu nsɛm nyinaa
- [zcashd Nkɔsoɔ a wɔto no awieɛ ho nkrabɔ](https://z.cash/support/zcashd-deprecation)

---

*Sɛ wohunu sɛ saa akwankyerԑ yi so wɔ mfaso a, dwen ho sε wobɛtumi aboa ZecHub: [Insert current ZecHub donation shielded address from zechub.wiki/donation  not included here since I couldn't verify it is still current].*
