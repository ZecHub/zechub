...
# ShapeShift ne Zcash: Kokoamsɛm-Aguadi a Edi Kan a Wɔde Di Dwuma wɔ Decentralized
...
Zcash boa address ahorow abien:

- **Transparent addresses** (t-addresses): Eyinom yɛ adwuma te sɛ Bitcoin addresses, baabi a wotumi hu ayɔnkofa ho nsɛm wɔ baguam wɔ blockchain no so.
- **Address a wɔabɔ ho ban** (z-addresses): Eyinom de adanse a wonni nimdeɛ di dwuma de sie asɛm no ho nsɛm kokoam.

Wɔn a wɔde di dwuma no betumi de ZEC amena wɔ address a ɛda adi ne nea wɔabɔ ho ban ntam. Sɛnea ɛbɛyɛ na wɔakora kokoam nsɛm so kɛse no, nkitahodi a efi address biako a wɔabɔ ho ban so kɔ foforo so no nna nsɛm biara adi wɔ baguam.
...
Sikasɛm mu kokoamsɛm nyɛ nea ɛfa nneyɛe bɔne a wɔde besie ho. Ɛbɔ ankorankoro ho ban fi ntua a wɔbɛhwɛ wɔn, nnwumakuw ho nsɛm a wɔboaboa ano, ne ntua a wɔde wɔn ani asi so ho. Sɛnea worempɛ sɛ ɔmanfo hu wo sikakorabea akontaabu mu sika no, saa ara na cryptocurrency nnwuma fata kokoamsɛm a ɛte saa ara. Zcash de eyi ma denam nhyehyɛe so.

---

## Sɛnea Wobɛsesa ZEC wɔ ShapeShift so

ShapeShift platform no ma wɔn a wɔde di dwuma no nya na wɔtɔn ZEC denam nhyehyɛe a wɔde ahyɛ aman nyinaa so koraa so. Sɛnea ɛyɛ adwuma ni.
...
Fa swap interface no paw agyapadeɛ a wopɛ sɛ wodi gua firi mu (sɛ nhwɛsoɔ no, BTC, ETH, anaa ERC-20 token) na hyehyɛ ZEC sɛ agyapadeɛ a wopɛ sɛ wokɔ. Wɔayɛ ShapeShift interface no wɔ nhyehyɛe a ɛho tew, Uniswap-style a wɔayɛ no yiye ama desktop ne mobile nyinaa.
...
Hwɛ asɛm no mu nsɛm a ɛfa asɛm no ho na si so dua. Wɔnam decentralized protocols so na ɛyɛ swap no wɔ nkɔnsɔnkɔnsɔn so. Wɔde wo ZEC no bɛkɔ address a woakyerɛ no so. Ntamgyinafo biara nni hɔ a okura wo sika da.
...
ShapeShift ma ZEC swaps tumi fa blockchain ecosystems pii so, a nea ɛka ho ne:

- **Bitcoin** (BTC) na ɛyɛ adwuma wɔ ɔkwan a ɛyɛ nwonwa so. ZEC
- **Ethereum** (ETH) na ɛyɛ adwuma wɔ ɔkwan a ɛyɛ nwonwa so. ZEC
- **Arbitrum** agyapadeɛ &lt;-&gt; ZEC
- **Cosmos** abɔdeɛ a nkwa wom ho nsɛnkyerɛnneɛ &lt;-&gt; ZEC

---

## Nea Enti a Saa Nkabom Yi Ho Hia

### Kokoamsɛm a Wɔbɛsan Agye wɔ DeFi mu
...
Abakɔsɛm no ma saa nkabom yi yɛ nea ɛho hia kɛse mpo. Wɔ afe 2020 mu, berɛ a na ShapeShift da so ara yɛ adwumakuo a ɛwɔ mfimfini no, ɛ **yii kokoamsɛm sika** a Zcash ka ho wɔ mmara mu nhyɛsoɔ ase. Nsakraeɛ a ɛkɔɔ DAO nhyehyɛeɛ mu no maa ShapeShift nyaa ahofadie firii saa anohyetoɔ no mu. Seesei, sɛ́ protocol a ɛhwɛ mpɔtam hɔ so no, ɛnyɛ sɛ ShapeShift asan akyerɛw Zcash nko na mmom ama ayɛ ne kokoam nsɛm ho nhyehyɛe no fã titiriw.

Ɛnam sɛ wɔyii **ShapeShift v4.0** adi wɔ December 2025 mu nti, Zcash bɛyɛɛ platform no **primary kokoamsɛm-kora sikatua ne routing agyapadeɛ**. Mprempren wɔde kokoamsɛm asi hɔ sɛ ade a wɔahyɛ da ayɛ, ɛnyɛ ade a wɔde ka ho a wobetumi apaw, a ZEC a wɔde ahyɛ ShapeShift sika kotoku ne routing stack mu tẽẽ.
...
Bere a mmarahyɛbea ahorow reyɛ den wɔ wiase nyinaa, a mpɔtam te sɛ EU rehwehwɛ anohyeto ahorow a ɛwɔ mfiridwuma a ɛkora kokoam nsɛm so no, nhyiam ahorow te sɛ ShapeShift ma wonya nhyehyɛe foforo a ɛho hia ma sikasɛm mu kokoamsɛm.

---

## Tɔfabɔ

| Feature a ɛwɔ | Nsɛm a ɛkɔ akyiri |
|---|---|
| **Asɛnka agua** | ShapeShift DAO (a wɔde ahyɛ aman nyinaa nsa, a wɔabue ano) |
| **Aban ho nsɛm** | FOX token a wɔde hyɛ mu |
| **Zcash Mmoa** | Full ZEC aguadi ne shielded asɛmdi mmoa |
| **KYC a Wɔhwehwɛ** | Dabi |
| **Ahwɛfoɔ** | Non-custodial (wɔn a wɔde di dwuma no de wɔn ankasa nsafe sie) |
| **Nneɛma a Wɔde Sesa Nkɔnsɔnkɔnsɔn** | BTC, ETH, Arbitrum, Cosmos, ne nea ɛkeka ho |
