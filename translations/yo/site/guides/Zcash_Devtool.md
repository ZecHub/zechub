# Ohun èlò ìjìnlẹ̀ Zcash Devtool

[Kínni Zcash-Devtool náà?](https://github.com/zcash/zcash-devtool?tab=readme-ov-file) 
...
### Ẹkọ fidio ti Zcash Devtool:
Kris Nuttycombe (@nuttycom) ṣafihan ọpa yii lakoko ZconVI.
...
Fun itọsọna igbesẹ nipasẹ igbesilẹ fun bi o ṣe le bẹrẹ lilo awọn irinṣẹ wọnyi, wo [yi walkthrough](https://github.com/zcash/zcash-devtool/blob/main/doc/walkthrough.md). It documents a full walkthrough of how to set up and use the zcash devtool tooling. It is intended to serve as a guide for how to get setup and how to add your own functionality to the tool.


Ìkìlọ̀ Ààbò:
Ẹ má ṣe lo èyí nínú iṣẹ́ ìkórè!!!
...
### Àkójọ àwọn ìsọfúnni (librustzcash tutorial)


[Wò fídíò yìí](https://free2z.cash/uploadz/public/ZcashTutorial/librustzcash-a-rust-crates.mp4)
